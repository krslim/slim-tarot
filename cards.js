// Enhanced Major Arcana - Rider-Waite-Smith traditional meanings
// Format: subtitle / general / love / career / health (upright & reversed)
...
export const DECK = [
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "New beginnings, innocence, spontaneity, a leap of faith",
        "general": "The Fool stands at the threshold of a journey, a small bag slung over one shoulder carrying only the essentials of past experience, a white rose in hand symbolising purity of intention. The cliff edge ahead represents the unknown, yet the figure steps forward with eyes lifted toward the bright sun—divine guidance and infinite potential. This is card zero: not emptiness, but all possibilities contained in a single moment. The Fool asks you to trust the universe enough to take the first step, even when the path isn't visible. There is wisdom in beginning again with open eyes and an unburdened heart. The small dog at your heels is both companion and warning—instinct will guide you, but stay present. This is not recklessness; it is faith in motion.",
        "love": "The Fool in love is the spark before the flame catches—a new connection filled with possibility, or an existing relationship rediscovering playfulness and wonder. If you're single, this card encourages you to say yes to unexpected invitations and approach dating with curiosity rather than a checklist. There's something refreshing about not knowing where things will lead. For those partnered, The Fool invites you to release old patterns and assumptions about each other. Try something spontaneous together: a trip with no itinerary, a conversation without defensiveness, a gesture of affection without expectation. The white rose reminds you that love thrives on sincerity, not strategy. Trust the feeling, not the forecast.",
        "career": "Professionally, The Fool marks the start of something new—a role, a project, a direction you've been curious about but hesitant to pursue. You don't need every credential or a five-year plan. What you need is willingness. This card often appears when someone is considering a career shift, starting a business, or returning to study later in life. The universe is asking: what would you try if you knew you couldn't fail? That said, The Fool's bag contains *some* supplies—bring what you've learned, but don't let past disappointments weigh you down. Say yes to the opportunity that makes your heart race slightly. Imposter syndrome is normal; courage is acting anyway. Document your journey as you go—you'll want to remember this beginning.",
        "health": "The Fool supports fresh starts in wellness: the first day of a new routine, committing to walk daily, trying a form of movement you've never considered, or simply deciding to treat your body with more kindness. This isn't about dramatic transformation—it's about showing up with beginner's mind. The bright sun overhead suggests vitamin D, outdoor time, and activities that lift your spirits. Spiritually, The Fool is permission to explore without committing to a single path. Meditate, journal, walk in nature, try a class. Stay light. Your body knows how to heal when you stop forcing outcomes. The dog beside you is your intuition—notice what feels expansive versus what feels constricting. Start small, stay curious, let joy be your guide."
      },
      "reversed": {
        "subtitle": "Recklessness, risk-taking, naivety, holding back, fear of change",
        "general": "Reversed, The Fool's energy splits in two directions: either you're stepping forward without looking, or you're frozen at the cliff's edge, refusing to move at all. The first warns of impulsivity—making decisions based on escape rather than inspiration, ignoring practical concerns, or trusting the wrong people because you want to believe. The small bag is empty now; you've left wisdom behind. The second warns of the opposite trap: overthinking, waiting for perfect conditions, or letting fear of looking foolish keep you stuck. The dog barks louder here—your instincts are trying to tell you something. Pause. Ask: am I being reckless, or am I hiding behind caution? The middle path is conscious risk: acknowledging uncertainty while taking responsibility for outcomes. The sun still shines; you've just turned away from it.",
        "love": "In relationships, reversed Fool energy shows up as either too little boundaries or too much walls. You might be ignoring red flags because the chemistry feels exciting, jumping into something before you're ready, or attracting partners who are emotionally unavailable and calling it 'keeping things light.' Alternatively, you may be so guarded that nothing new can enter—past hurts have made you cynical, and you're mistaking protection for wisdom. If you're partnered, there may be avoidance of important conversations or a pattern of creating drama to avoid intimacy. The reversal asks: where are you being naive, and where are you being unnecessarily fearful? Clarity is kinder than games. If something feels unstable, name it. If you're ready for more, say so.",
        "career": "Career-wise, watch for two patterns: leaping without a net, or refusing to leap at all. The first looks like quitting without savings, making promises you can't keep, or trusting verbal agreements that should be written. The universe supports boldness, not foolishness. Get the details in order. The second pattern is paralysis—staying in a role that drains you because the unknown feels scarier than the familiar misery. You're waiting for certainty that will never come. Between these extremes is wise action: update your CV, save three months of expenses, have honest conversations, test the waters before diving. If you're being asked to take on risk at work, ensure the rewards match. Don't let anyone romanticise instability as 'growth.'",
        "health": "Reversed, The Fool can indicate health choices made from desperation rather than discernment—extreme diets, unproven supplements, or ignoring medical advice in favour of quick fixes. Alternatively, you may know what you need to do but keep postponing it, telling yourself you'll start 'when things settle down.' The cliff edge hasn't moved; you're just pacing in place. Your body is asking for consistency, not perfection. Start with one non-negotiable: sleep at a regular time, drink water, move for ten minutes daily. Spiritually, you may be chasing every new practice without deepening any of them, or refusing to explore because it feels 'woo-woo.' Meet yourself in the middle. Ground first, then expand. The dog is still with you—listen when something feels off, even if you can't explain why."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Manifestation, resourcefulness, power, inspired action",
        "general": "The Magician stands with one hand raised toward heaven, the other pointing to earth—'as above, so below.' Before him on the table lie the four suits of the tarot: wand, cup, sword, and pentacle. He has all the tools. The infinity symbol floats above his head; the ouroboros belt circles his waist. This is card number one: the first active step after The Fool's leap. The Magician doesn't create from nothing—he channels what already exists, directing energy with intention and skill. You have everything you need. The question is whether you'll use it. This is a time of competence, clarity, and the confidence that comes from knowing you can affect your reality. Speak your truth. Take the action. Make it real.",
        "love": "The Magician in love is someone who knows what they want and isn't afraid to pursue it. If you're single, this card suggests putting yourself out there with authenticity—your charm is magnetic right now, but it's your sincerity that will draw the right person. For those in relationships, this is a card of conscious creation: you can improve what you have through communication, effort, and presence. Stop waiting for your partner to read your mind. Say what you need. Plan the date. Initiate the conversation. The Magician reminds you that love is a verb. You have the tools to build something beautiful—use them with integrity, not manipulation.",
        "career": "This is one of the strongest career cards in the deck. The Magician says: you have the skills, the opportunity, and the timing. Now execute. Present the idea. Launch the project. Ask for the promotion. This card favours entrepreneurs, creatives, communicators, and anyone whose work involves turning vision into reality. Your ability to synthesise information and present it clearly is heightened. Networking works. Learning new skills sticks. Just remember: the Magician's power comes from alignment, not force. Don't oversell. Don't manipulate. Let your genuine competence speak. Document your wins—they'll matter later.",
        "health": "The Magician supports mind-body connection work: meditation, breathwork, yoga, or practices that unite intention with physical action. This is an excellent time to start a fitness routine because you'll have the mental discipline to follow through. The card also suggests that your thoughts are shaping your physical state more than usual—positive self-talk and visualisation can support healing. If you've been researching a health concern, now is the time to consult a professional and take action. Spiritually, you're in a phase of active practice rather than passive learning. Teach what you know. Share your gifts. The universe flows through you when you stay humble and focused."
      },
      "reversed": {
        "subtitle": "Manipulation, poor planning, untapped talents, illusion",
        "general": "Reversed, the Magician's gifts become distorted. The tools are still on the table, but you're either misusing them or refusing to pick them up. This can show up as manipulation—using charm or intelligence to control outcomes rather than create them. It can also appear as imposter syndrome: you have everything you need, but you don't believe it. Watch for procrastination disguised as preparation, or confidence that's all performance with no substance. The infinity symbol becomes a loop you can't escape. Ask yourself: am I being honest about my intentions? Am I taking action, or just talking about it? The Magician reversed asks you to ground your power in integrity. Stop performing. Start doing.",
        "love": "In love, the reversed Magician can indicate someone who is charming but inconsistent—words don't match actions. This could be you or your partner. There may be game-playing, withholding, or a relationship that feels more like negotiation than connection. If you're single, beware of projecting qualities onto someone you barely know. The chemistry is real, but is the character? For those partnered, stop trying to 'fix' your partner through cleverness. Have the honest conversation. If you've been manipulating situations to get your needs met, try direct communication instead. Love thrives on authenticity, not strategy.",
        "career": "Career-wise, this reversal warns against overpromising and underdelivering. You may be tempted to exaggerate your skills or commit to timelines you can't meet. Don't. The short-term gain isn't worth the long-term reputation damage. Alternatively, you may be holding back—afraid to show your work, hesitant to claim credit, waiting for permission that will never come. Your talents are real. Use them. If you're feeling stuck, break projects into smaller steps and complete them one at a time. Momentum builds confidence. Also watch for office politics: someone may be presenting themselves more favourably than reality supports. Verify before you trust.",
        "health": "Reversed, the Magician can indicate health approaches that are all theory and no practice—you've researched extensively but haven't changed anything. Or you're trying to 'hack' your health with shortcuts rather than building sustainable habits. There's also a warning about placebos and false promises: if something sounds too good to be true, it probably is. Work with qualified professionals. Follow through on what you start. Spiritually, you may be using practices to escape rather than engage—meditation to avoid feelings, spirituality to bypass responsibility. True power comes from integration, not avoidance. Ground yourself. Be honest. Do the work."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Intuition, sacred knowledge, divine feminine, the subconscious mind",
        "general": "The High Priestess sits between two pillars—one black, one white—guarding the veil between the conscious and unconscious mind. Behind her hangs a tapestry depicting palms and pomegranates, symbols of fertility and hidden wisdom. At her feet rests the crescent moon; in her lap, the scroll of divine law, partially concealed. She does not speak; she waits. The High Priestess is card number two: the first receptive card, the complement to The Magician's action. She represents knowledge that comes not from study but from sensing, not from proving but from knowing. Your intuition is heightened now. Dreams may be vivid. Pay attention to what you feel but cannot explain. The answers you seek are already within you—quiet yourself enough to hear them.",
        "love": "In matters of the heart, the High Priestess asks you to listen to what isn't being said. There is depth here—emotional undercurrents, unspoken attraction, or a connection that operates on a soul level. If you're single, you may meet someone through a dream, a synchronicity, or in a quiet moment when you're not looking. Don't force it. For those partnered, this card invites you to create space for vulnerability and silence together. Not every feeling needs to be analysed immediately. Some things reveal themselves in stillness. If something feels off in your relationship, trust that feeling even if you can't articulate why. Your body knows before your mind catches up.",
        "career": "Professionally, the High Priestess favours research, strategy, and behind-the-scenes work. This is not a time to push aggressively forward; it's a time to gather information, observe patterns, and trust your instincts about office dynamics. You may notice things others miss—pay attention. This card also supports creative and intuitive work: writing, psychology, healing arts, or any field that requires deep listening. If you're considering a career move, wait for clarity rather than forcing a decision. The right opportunity will feel different—it will resonate in your body, not just look good on paper. Keep confidences. Not everything needs to be shared.",
        "health": "The High Priestess governs cycles—menstrual, lunar, seasonal. Honour your body's rhythms rather than fighting them. Rest when you need to rest; move when energy flows. This card also suggests that stress may be manifesting as physical symptoms—your body is speaking a language you've been ignoring. Journal, meditate, spend time near water. Pay attention to dreams; they may contain information about your wellbeing. Spiritually, this is a time to deepen your inner practice. You don't need more information; you need more silence. The wisdom you seek is already within you. Trust the quiet voice."
      },
      "reversed": {
        "subtitle": "Repressed intuition, secrets, disconnection from self, surface-level thinking",
        "general": "Reversed, the High Priestess indicates a disconnect from your inner knowing. You may be ignoring clear intuitive signals, overthinking what should be felt, or drowning out your inner voice with noise and distraction. Alternatively, this card can warn of secrets—things hidden from you or things you're hiding from yourself. There may be information you need that isn't available yet; patience is required. The reversed High Priestess asks: what are you refusing to feel? What truth are you avoiding? The pillars still stand; you've just turned away from the veil. Reconnect through solitude, silence, and honest self-inquiry. Your intuition hasn't left—you've stopped listening.",
        "love": "In love, this reversal can indicate emotional unavailability—yours or your partner's. There may be things left unsaid that are creating distance, or you're intellectualising feelings rather than experiencing them. If you're single, you might be attracted to people who are mysterious in unhealthy ways—unavailable, secretive, or emotionally withholding. Ask direct questions. Watch for actions, not just words. For those partnered, create space for honest conversation. If you've been sensing something is off, address it gently but directly. Secrets erode trust. The High Priestess reversed asks you to bring what's hidden into the light—not to punish, but to heal.",
        "career": "Career-wise, the reversed High Priestess warns against making decisions based on incomplete information. You may be missing key details, misreading office politics, or trusting your gut when you should be verifying facts. Alternatively, you may know something important but are afraid to speak up. If you're sensing dysfunction or unethical behaviour, document what you observe and protect yourself. This is also a warning against gossip and rumours—verify before you act. If you're feeling disconnected from your work, ask yourself what you're avoiding. Sometimes the issue isn't the job; it's that you've lost touch with what matters to you.",
        "health": "Reversed, this card can indicate ignoring your body's signals—pushing through fatigue, dismissing symptoms, or using busyness to avoid dealing with health concerns. Stress may be manifesting as anxiety, insomnia, or digestive issues. Slow down. Your body is trying to communicate. There's also a warning against self-diagnosis or relying on internet research instead of professional care. Get the checkup. Ask the question. Listen to qualified advice. Spiritually, you may be using spiritual practices to escape rather than engage—avoiding difficult emotions by staying 'zen.' True spiritual maturity includes facing what's uncomfortable. Feel your feelings. They're not enemies; they're messengers."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Femininity, beauty, nature, nurturing, abundance, creativity",
        "general": "The Empress sits in a lush garden, surrounded by growth and abundance. Wheat grows at her feet; a heart-shaped shield bearing Venus's symbol rests beside her. She wears a crown of twelve stars and a flowing gown, pregnant with possibility. The Empress is card number three: the first card of manifestation after the dualities of Priestess and Magician. She represents the fertile earth itself—what you nurture will grow. This is a time of creativity, sensuality, and receiving. You don't have to earn love or abundance; you are worthy by nature. Allow yourself to be cared for. Create something beautiful. Connect with nature. The Empress reminds you that rest is productive, pleasure is purposeful, and caring for yourself is not selfish—it's essential.",
        "love": "The Empress in love is warmth, affection, and deep emotional nourishment. If you're single, you're radiating an energy that draws others to you—embody what you seek. Be the partner you want to attract: kind, present, generous with affection. For those in relationships, this card suggests a phase of deepening intimacy, possibly moving toward commitment, cohabitation, or family planning. There's a sensuality here that goes beyond the physical—it's about creating a relationship that feels like home. Give and receive freely. Express appreciation. Make your space beautiful together. The Empress asks: are you nurturing this connection, or taking it for granted?",
        "career": "Professionally, the Empress favours creative projects, building something with lasting value, and work that helps others flourish. This is an excellent time for entrepreneurs, artists, caregivers, and anyone whose work involves creation or nurturing. Collaboration thrives now—people want to contribute to something meaningful. Focus on quality over speed. Invest in relationships with colleagues and clients; these connections will bear fruit. If you've been waiting to launch a creative project, the timing is favourable. Trust your aesthetic sense. Make it beautiful. The Empress also reminds you to create a work environment that supports your wellbeing—plants, natural light, comfort matter.",
        "health": "The Empress governs the body's capacity for pleasure and rest. This card supports recovery, gentle movement, and nourishing your body with whole foods and adequate sleep. It's also a reminder that stress management isn't optional—it's foundational. Spend time in nature. Eat meals without rushing. Prioritise activities that bring you joy. For those dealing with hormonal issues, reproductive health, or body image concerns, the Empress invites you to make peace with your physical form. Your body is not a project to be fixed; it's a home to be honoured. Spiritually, connect with the earth itself—walk barefoot, garden, sit under trees. You are held."
      },
      "reversed": {
        "subtitle": "Creative blocks, dependence on others, neglecting self-care, smothering",
        "general": "Reversed, the Empress's nurturing energy becomes imbalanced. You may be overgiving—pouring into others while depleting yourself—or you may be unable to receive, pushing away care and insisting on handling everything alone. Creative blocks often appear with this reversal: you want to create, but something feels stuck. The garden is overgrown; the wheat is untended. Ask yourself: where am I neglecting my own needs? Where am I trying to control growth instead of allowing it? The Empress reversed asks you to rebalance. Set boundaries around your energy. Accept help. Create for yourself, not for approval. Abundance flows when you stop forcing it.",
        "love": "In relationships, the reversed Empress can indicate codependency—caring for your partner to the point of losing yourself, or expecting your partner to be your sole source of emotional nourishment. There may be insecurity manifesting as clinginess or jealousy. Alternatively, you might be withholding affection as a form of control. If you're single, you may be waiting for someone to 'complete' you rather than cultivating wholeness within. The Empress reversed asks: are you nurturing this relationship, or suffocating it? Love requires space to breathe. Give freely, but maintain your own garden. You cannot pour from an empty cup.",
        "career": "Career-wise, this reversal warns of burnout from overgiving—taking on too much, helping everyone else while your own projects stagnate. You may also be experiencing creative block, waiting for inspiration instead of creating conditions that allow it to flow. Simplify. Delegate. Say no to requests that drain you. If you're in a caregiving role, ensure you have support. There's also a warning against nepotism or favouritism—yours or others'. Merit matters. If you're feeling stuck, reconnect with why you started this work. What brings you joy? Start small. Create something just for you. The Empress reversed reminds you: you can't nurture others from emptiness. Fill your own cup first.",
        "health": "Reversed, the Empress suggests neglecting basic self-care—skipping meals, poor sleep, ignoring your body's need for rest and pleasure. You may be pushing yourself too hard, believing that rest is earned rather than essential. There's also a warning about using food, shopping, or other pleasures to numb rather than nourish. True self-care is consistent, not indulgent. Start with basics: regular meals, hydration, movement you enjoy, adequate sleep. Spiritually, you may have disconnected from nature or your body—living entirely in your head. Reconnect through your senses. Touch, taste, smell, see, hear. You are an embodied being. Honour that."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Authority, structure, control, fatherhood, stability, leadership",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Tradition, conformity, morality, ethics, spiritual wisdom, institutions",
      ...
      "reversed": {
        ...
        "general": "Reversed, the Hierophant indicates tension with established systems. You may be questioning beliefs you inherited, chafing against rules that no longer serve you, or realising that authority figures don't deserve your automatic respect. This can be healthy rebellion—outgrowing limitations—or it can be rebellion for its own sake, rejecting wisdom along with dogma. The reversed Hierophant asks: what beliefs are you holding because they're comfortable rather than true? What traditions honour you, and which constrain you? You're allowed to forge your own path. Just ensure you're not throwing away wisdom with the rules. Examine. Question. Choose consciously.",
        "love": "In relationships, this reversal can indicate non-traditional arrangements—long-distance, age gaps, cultural differences, or relationships that don't fit family expectations. There may be pressure from family or community to conform to their vision of what your relationship should be. The reversed Hierophant asks: whose life is this? If you're single, you may be attracted to people outside your 'type' or social circle. That's fine—just ensure you're connecting authentically, not rebelling against expectations. For those partnered, have honest conversations about values. Are you together because you share beliefs, or because it's expected? Authenticity matters more than approval.",
        "career": "Career-wise, the reversed Hierophant suggests you've outgrown your current environment—the methods feel outdated, the culture stifling, or the leadership unworthy of your respect. This can be a time of healthy change: starting your own business, switching industries, or finding mentors who align with your values. Alternatively, you may be tempted to reject all structure, believing that rules don't apply to you. They do. The question is which rules serve you. If you're being asked to compromise your ethics, that's not tradition—that's corruption. Trust your judgment. Forge your path. Just remember: even rebels need discipline.",
        "health": "Reversed, this card can indicate rejecting conventional medicine in favour of alternatives—sometimes wisely, sometimes not. If conventional approaches haven't worked for you, exploring other options is reasonable. Just ensure you're not rejecting helpful treatments out of distrust or ideology. Get second opinions. Research thoroughly. Your health is too important for dogma on either side. There's also a warning about health beliefs inherited from family that may not serve you—'we just don't go to doctors' or 'real men don't show weakness.' Examine these beliefs. Choose what serves your wellbeing. You're allowed to break family patterns. Your body deserves evidence-based care."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Love, harmony, relationships, values alignment, choices, union",
      ...
      "reversed": {
        ...
        "general": "Reversed, the Lovers indicates misalignment—your choices don't match your values, or you're avoiding a choice that needs to be made. This can show up as inner conflict (wanting two incompatible things), outer conflict (disagreements with others), or simply feeling stuck because you're afraid to choose. The reversed Lovers asks: what are you avoiding? What choice feels difficult because both options have costs? Not choosing is itself a choice—one that often costs more in the long run. Examine your values. What truly matters? Make the choice that honours those values, even if it's difficult. Clarity comes through commitment, not hesitation.",
        "love": "In relationships, the reversed Lovers can indicate disharmony—miscommunication, conflicting values, or choices that have created distance. There may be temptation—yours or your partner's—or a relationship that looks good from the outside but feels wrong from within. If you're single, you may be attracted to someone who isn't available, or you're staying single out of fear rather than choice. For those partnered, have honest conversations about where you're misaligned. Are you both committed to the same vision? Are there unmet needs? The reversed Lovers doesn't mean the relationship is doomed—it means work is needed. Choose each other consciously, or choose to part with respect.",
        "career": "Career-wise, this reversal warns of choices made from fear or external pressure rather than authentic desire. You may have taken a job for the money that drains your soul, or stayed in a role too long out of comfort. Alternatively, you may be facing a difficult decision and paralysed by fear of choosing wrong. There is no perfect choice—only the choice you make and the commitment you bring to it. If you're in a partnership that isn't working, address it directly. Unclear agreements create resentment. If you're considering leaving, plan strategically. Don't burn bridges; build new ones. Choose with intention, then commit fully.",
        "health": "Reversed, the Lovers can indicate inner conflict manifesting physically—stress from competing priorities, guilt about self-care, or health choices that don't align with your values. You may know what you should do but keep choosing differently. Examine why. Is it fear? Convenience? People-pleasing? There's also a warning about relationships affecting health—staying in stressful dynamics, isolating when you need support, or neglecting health to care for others. You can't pour from an empty cup. Make choices that honour your wellbeing. Seek support. You don't have to navigate this alone. Choose health. Choose harmony. Choose yourself."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Control, willpower, success, action, determination, victory",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Strength, courage, persuasion, influence, compassion, inner power",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Introspection, solitude, inner guidance, soul-searching, wisdom",
      ...
      "reversed": {
        ...
        "general": "Reversed, the Hermit indicates unhealthy isolation—withdrawing from others not for growth but from fear, or feeling lonely even when surrounded by people. You may be rejecting helpful advice, believing you have to figure everything out alone, or using solitude to avoid difficult emotions. The lantern is either hidden or pointing the wrong way. The reversed Hermit asks: are you withdrawing for the right reasons? Is this solitude serving you, or are you hiding? There's a difference between choosing silence and being trapped in it. If you're feeling isolated, reach out. Connection heals. You don't have to navigate this alone. Wisdom isn't just found in solitude—it's also found in community. Let others in.",
        "love": "In relationships, this reversal can indicate emotional unavailability—withholding, stonewalling, or using space as punishment. Alternatively, you may be feeling abandoned or neglected by your partner. If you're single, you may be isolating yourself, believing you're better off alone, or you may be so focused on self-improvement that you're not making space for connection. For those partnered, communicate your needs clearly. If you need space, say why. If you're feeling neglected, express it without accusation. The reversed Hermit reminds you: relationships require both solitude and connection. Find balance. Don't use independence as an excuse to avoid intimacy. Vulnerability is the price of connection. Pay it.",
        "career": "Career-wise, reversed Hermit warns of isolation at work—refusing collaboration, rejecting feedback, or believing you have to do everything yourself. This leads to burnout and stagnation. No one succeeds alone. Ask for help. Accept support. There's also a warning about imposter syndrome—feeling like you don't belong, so you withdraw rather than risk rejection. You belong. Your contributions matter. If you're considering a career change, don't make the decision in isolation. Talk to people in the field. Get perspective. Wisdom isn't just internal—it's also external. Learn from others. You don't have to reinvent the wheel. Stand on the shoulders of those who came before.",
        "health": "Reversed, this card can indicate health issues from isolation—depression, anxiety, or physical symptoms from loneliness. Humans are social creatures; connection is a biological need, not a luxury. If you're struggling, reach out. Therapy, support groups, or trusted friends can help. There's also a warning about rejecting medical advice or refusing to seek help—believing you should handle everything alone. You shouldn't. Your health matters. Get the checkup. Ask the question. Accept support. Spiritually, you may be using solitude to avoid dealing with difficult emotions or traumas. Healing often requires witness. Let someone in. You don't have to carry this alone. Connection heals. Let it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Good luck, karma, life cycles, destiny, a turning point, change",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Justice, fairness, truth, cause and effect, law, accountability",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Pause, surrender, letting go, new perspectives, sacrifice, suspension",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Endings, change, transformation, transition, letting go, rebirth",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Balance, moderation, patience, purpose, harmony, alchemy",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Shadow self, attachment, addiction, restriction, sexuality, materialism",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Sudden change, upheaval, chaos, revelation, awakening, destruction",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Hope, faith, purpose, renewal, spirituality, healing, inspiration",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Illusion, fear, anxiety, subconscious, intuition, dreams, confusion",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Joy, success, celebration, positivity, vitality, warmth, clarity",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Judgement, rebirth, inner calling, absolution, awakening, reckoning",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        "subtitle": "Completion, integration, accomplishment, travel, wholeness, celebration",
  ...
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Ace of Cups shows a hand emerging from a cloud, holding a chalice from which water overflows. Five streams pour forth—the senses, the elements, grace. This is the seed of emotion, the beginning of love, the first stirrings of compassion. The Ace of Cups asks you to open your heart. What wants to flow through you? Love, creativity, intuition, spiritual connection—all begin here. This card represents emotional fullness, the capacity to feel deeply, and the willingness to receive. Don't hold back. Let yourself feel. Let yourself love. The cup is overflowing. Drink deeply.",
        "love": "In love, the Ace of Cups is one of the most auspicious cards—a new relationship beginning, deep feelings emerging, or existing love renewed. If you're single, this card suggests you're open to love and someone may enter your life soon. For those in relationships, the Ace of Cups indicates deepening emotional intimacy, renewed affection, or a phase of emotional abundance. This card reminds you: love begins with openness. Open your heart. Let yourself feel. Let yourself be loved.",
        "career": "Professionally, the Ace of Cups indicates work that fulfils you emotionally—creative projects, helping professions, or roles that allow you to express compassion. This card supports following your intuition about career direction. If you've been considering a change toward more meaningful work, this is encouragement. The Ace of Cups also indicates positive workplace relationships, emotional satisfaction from your work, or creative inspiration flowing. Trust your feelings about work. What brings you joy? Pursue it.",
        "health": "The Ace of Cups governs emotional and spiritual wellbeing—feeling connected, compassionate, and open. This card supports practices that nurture your emotional health: therapy, meditation, creative expression, or simply allowing yourself to feel. The Ace of Cups reminds you: emotions aren't problems to solve. They're experiences to have. Let yourself feel. Let yourself heal. Your emotional health matters. Prioritise it."
      },
      "reversed": {
        "subtitle": "Emotional loss, blocked creativity, emptiness, repressed feelings",
        "general": "Reversed, the Ace of Cups indicates blocked emotions—feelings you're suppressing, love you're afraid to receive, or creativity that's stuck. The cup is empty or overturned. The reversed Ace of Cups asks: what are you afraid to feel? What emotions are you avoiding? This card also indicates emotional depletion—giving too much without replenishing, or feeling empty despite external success. The reversed Ace of Cups reminds you: emotions want to flow. Blocking them creates pressure. Let yourself feel. Seek support if needed. Your heart deserves to be full.",
        "love": "In love, this reversal indicates emotional blocks—fear of vulnerability, past hurts preventing connection, or feeling emotionally unavailable. If you're single, you may be attracting partners when you're not ready, or avoiding love out of fear. For those in relationships, the reversed Ace of Cups suggests emotional distance, unexpressed feelings, or one person giving more than the other. This card asks: what's blocking your heart? Address it. Healing is possible. Love is waiting.",
        "career": "Career-wise, reversed Ace of Cups indicates emotional dissatisfaction—work that drains you, lack of creative fulfilment, or feeling disconnected from your purpose. You may be succeeding externally but feeling empty internally. This card asks: what would bring emotional satisfaction to your work? More meaning? More creativity? More connection? Address it. Your career deserves to feed your soul, not just your bank account.",
        "health": "Reversed, this card indicates emotional health issues—depression, anxiety, or suppressing feelings until they manifest physically. You may be neglecting your emotional needs, or using unhealthy coping mechanisms. The reversed Ace of Cups asks: what support do you need? Therapy? Community? Rest? Seek it. Your emotional health is health. Treat it that way."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Two of Cups depicts a man and woman exchanging cups beneath the caduceus of Hermes, symbolising healing through union. A lion's head appears above—passion tamed by partnership. The Two of Cups represents mutual attraction, balanced giving and receiving, and the joy of connection. This card asks you to meet another as an equal. No games. No power plays. Just two people choosing each other. The Two of Cups reminds you: the best relationships are partnerships. Both parties contribute. Both parties receive. Balance creates harmony. Seek it.",
        "love": "In love, the Two of Cups is one of the strongest cards for new relationships—mutual attraction, emotional connection, and the beginning of partnership. If you're single, this card suggests you may meet someone who feels like an equal partner. For those in relationships, the Two of Cups indicates harmony, renewed connection, or working through differences as a team. This card reminds you: love is a partnership. Meet each other as equals. Give and receive freely.",
        "career": "Professionally, the Two of Cups indicates partnerships, collaborations, and positive working relationships. This card supports team projects, business partnerships, or mentoring relationships. The Two of Cups reminds you: the best work happens in collaboration. Find partners who complement your skills. Build relationships based on mutual respect. Success is sweeter shared.",
        "health": "The Two of Cups governs relational health—the wellbeing that comes from supportive connections. This card supports healing through relationship—therapy, support groups, or simply having people who care. The Two of Cups reminds you: you don't have to heal alone. Connection is medicine. Let others in."
      },
      "reversed": {
        "subtitle": "Imbalance, broken communication, tension, disconnection, one-sided",
        "general": "Reversed, the Two of Cups indicates imbalance in relationships—giving more than you receive, miscommunication, or partnerships that aren't working. The cups don't meet; the connection is broken. The reversed Two of Cups asks: where is the imbalance? What isn't being said? This card also indicates attracting the wrong partners, or staying in relationships that don't honour you. The reversed Two of Cups reminds you: you deserve equal partnership. Don't settle for less. Walk away if needed.",
        "love": "In love, this reversal indicates relationship difficulties—miscommunication, imbalance, or attraction that isn't mutual. If you're single, you may be attracting unavailable partners, or giving too much too soon. For those in relationships, the reversed Two of Cups suggests working through differences, addressing imbalance, or recognising when a relationship isn't working. This card asks: are you both equally invested? If not, address it. You deserve reciprocity.",
        "career": "Career-wise, reversed Two of Cups indicates difficult partnerships—business relationships soured, team conflicts, or collaborations that aren't working. This card asks: is this partnership serving you? If not, renegotiate or end it. The reversed Two of Cups also warns of office politics, favouritism, or unprofessional relationships. Maintain boundaries. Protect yourself.",
        "health": "Reversed, this card indicates health issues from relationship stress—isolation, conflict affecting wellbeing, or lacking support when you need it. The reversed Two of Cups asks: what relationships are draining you? What support do you need? Address it. Your health is affected by your connections. Choose them wisely."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Three of Cups shows three women raising their cups in celebration, dancing in a circle surrounded by flowers and fruit. This is joy shared, friendship honoured, and community celebrated. The Three of Cups represents gatherings, celebrations, and the happiness that comes from connection. This card asks you to celebrate. Call your friends. Mark the occasion. Joy multiplies when shared. The Three of Cups reminds you: you don't have to do life alone. Community matters. Friendship matters. Celebrate what you have. Celebrate who you're with.",
        "love": "In love, the Three of Cups indicates celebrating your relationship—anniversaries, meeting friends, or simply enjoying each other's company with others. If you're single, this card suggests love may come through friends, social gatherings, or community events. The Three of Cups reminds you: don't isolate yourself in love. Let your relationship exist in community. Let friends support you. Celebration strengthens connection.",
        "career": "Professionally, the Three of Cups indicates positive team dynamics, workplace celebrations, or collaborative creative projects. This card supports networking, team building, and work that involves community. The Three of Cups reminds you: your colleagues can be friends. Celebrate wins together. Build community at work. Success is better shared.",
        "health": "The Three of Cups governs social wellbeing—the health benefits of friendship, community, and celebration. This card supports healing through connection—support groups, friend gatherings, or simply not isolating when you're struggling. The Three of Cups reminds you: loneliness harms health. Connection heals. Reach out. Celebrate. You're not alone."
      },
      "reversed": {
        "subtitle": "Overindulgence, gossip, isolation, cancelled plans, superficial connections",
        "general": "Reversed, the Three of Cups indicates excess—partying too much, superficial friendships, or celebrations that feel empty. Alternatively, it can indicate isolation—cancelled plans, feeling left out, or lacking community. The reversed Three of Cups asks: are your connections genuine? Are you overindulging to avoid feelings? This card also warns of gossip, cliques, or friendships that drain rather than nourish. The reversed Three of Cups reminds you: quality over quantity. One true friend beats a hundred acquaintances. Choose wisely.",
        "love": "In love, this reversal indicates third-party interference—friends disapproving, too much outside influence, or one partner prioritising friends over the relationship. If you're single, you may be focusing too much on partying rather than genuine connection. For those in relationships, the reversed Three of Cups asks: are you balancing couple time with friend time? Are outside opinions affecting your relationship? Address it. Your relationship deserves priority.",
        "career": "Career-wise, reversed Three of Cups indicates workplace gossip, cliques, or unprofessional behaviour at social events. This card warns of overindulgence at work functions, or friendships at work becoming problematic. The reversed Three of Cups also indicates feeling excluded from team activities. If you're being left out, examine why. Address it. Professional boundaries matter.",
        "health": "Reversed, this card indicates health issues from isolation or overindulgence—drinking too much, poor social habits, or lacking support when struggling. The reversed Three of Cups asks: are your social habits supporting your health? If not, change them. Seek genuine connection. Avoid excess. Your health is affected by your choices. Choose wisely."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Four of Cups depicts a figure sitting under a tree, arms crossed, staring at three cups before them. A fourth cup is offered by a hand from a cloud, but the figure doesn't notice. The Four of Cups represents apathy, dissatisfaction, and opportunities missed due to disengagement. This card asks: what are you refusing to see? What opportunities are you missing because you're focused on what's lacking? The Four of Cups reminds you: sometimes the problem isn't your circumstances. It's your perspective. Open your eyes. Open your heart. The gift is being offered. Receive it.",
        "love": "In love, the Four of Cups indicates emotional dissatisfaction—feeling unfulfilled in your relationship, or missing opportunities for connection because you're focused on what's wrong. If you're single, you may be rejecting potential partners because they don't match an ideal. For those in relationships, this card asks: are you taking your partner for granted? Are you focused on what's missing rather than what's present? Address it. Gratitude transforms relationships.",
        "career": "Professionally, the Four of Cups indicates career dissatisfaction—feeling bored, unfulfilled, or missing opportunities because you're disengaged. This card asks: are you seeing opportunities, or only limitations? If you're unhappy, take action. Update your skills. Network. Make changes. Don't wait for satisfaction to arrive. Create it.",
        "health": "The Four of Cups governs mental and emotional health—depression, apathy, or feeling disconnected from your body. This card asks: are you neglecting your health due to dissatisfaction? Are you missing opportunities for healing because you're focused on what's wrong? Address it. Small steps matter. Seek support. Your health deserves attention. Give it."
      },
      "reversed": {
        "subtitle": "Awareness, acceptance, new opportunities, emotional renewal, engagement",
        "general": "Reversed, the Four of Cups indicates emerging from apathy—finally seeing opportunities, accepting what's offered, or re-engaging with life. You're waking up from emotional numbness. The reversed Four of Cups asks: what are you ready to accept? What opportunities will you say yes to? This card reminds you: satisfaction comes from engagement, not perfection. Say yes. Show up. Participate. Life is happening. Join it.",
        "love": "In love, this reversal indicates renewed interest in relationships—seeing your partner freshly, accepting love that's offered, or being open to new connections. If you're single, you may be ready to date after a period of disinterest. For those in relationships, the reversed Four of Cups suggests re-engaging emotionally, appreciating what you have, or working through dissatisfaction. This card reminds you: love requires participation. Participate.",
        "career": "Career-wise, reversed Four of Cups indicates renewed interest in work—seeing opportunities, accepting new projects, or re-engaging with your career. This card supports making changes after a period of stagnation. If you've been unhappy, you're now ready to address it. Take action. Opportunities are available. Say yes.",
        "health": "Reversed, this card indicates emerging from health apathy—finally addressing issues, accepting help, or re-engaging with your wellbeing. The reversed Four of Cups reminds you: your health matters. Take action. Seek care. Small steps lead to big changes. Begin."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Five of Cups shows a cloaked figure staring at three spilled cups, mourning what's lost. Behind them, two cups remain standing, but the figure doesn't see them. The Five of Cups represents grief, disappointment, and the tendency to focus on loss rather than what remains. This card asks you to honour your grief—but don't get stuck in it. What's lost matters. What remains matters too. The Five of Cups reminds you: grief is love with nowhere to go. Feel it. Then turn around. Two cups are still full. Life continues. Hope remains.",
        "love": "In love, the Five of Cups indicates heartbreak, disappointment, or focusing on what went wrong in a relationship. If you're single, you may be dwelling on past relationships, unable to move forward. For those in relationships, this card suggests working through disappointment, grief over what could have been, or feeling like your partner isn't meeting your needs. The Five of Cups asks: what still works? What can be saved? Grieve what's lost. Then rebuild what remains.",
        "career": "Professionally, the Five of Cups indicates career disappointment—missed promotions, failed projects, or feeling like your career isn't working out. This card asks: are you focusing only on failures? What successes remain? What opportunities are still available? Grieve the loss. Then move forward. Your career isn't over. It's evolving.",
        "health": "The Five of Cups governs grief affecting health—depression, loss affecting wellbeing, or struggling to move forward after health setbacks. This card asks you to honour your grief while not losing hope. What health do you still have? What can you still do? Grieve what's lost. Then work with what remains. Healing is possible."
      },
      "reversed": {
        "subtitle": "Moving on, finding peace, accepting loss, seeing what remains, hope",
        "general": "Reversed, the Five of Cups indicates emerging from grief—accepting loss, seeing what remains, or finding hope after disappointment. You're turning around. The two full cups are visible now. The reversed Five of Cups asks: what have you learned from this loss? What still matters? This card reminds you: grief doesn't disappear. It transforms. You carry it forward, but it doesn't consume you. Hope returns. Life continues. Move forward.",
        "love": "In love, this reversal indicates healing from heartbreak—accepting a relationship ended, seeing what you learned, or being ready to love again. If you're single, you may be ready to date after grief. For those in relationships, the reversed Five of Cups suggests working through disappointment, accepting what can't change, or focusing on what works. This card reminds you: love survives loss. Open your heart again.",
        "career": "Career-wise, reversed Five of Cups indicates recovering from career disappointment—accepting setbacks, seeing remaining opportunities, or finding new direction after loss. This card supports moving forward after failure. You've learned. You've grown. Now begin again. Your career isn't defined by one loss. Keep going.",
        "health": "Reversed, this card indicates healing from health grief—accepting diagnoses, finding hope after setbacks, or working with what remains. The reversed Five of Cups reminds you: your health journey continues. Grieve what's lost. Then focus on what you can do. Healing is possible. Move forward."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Six of Cups depicts two children exchanging cups filled with flowers in a courtyard. The scene is simple, innocent, reminiscent of childhood. The Six of Cups represents nostalgia, happy memories, and the sweetness of simpler times. This card asks you to reconnect with your inner child. What brought you joy before life became complicated? The Six of Cups reminds you: nostalgia isn't about living in the past. It's about remembering what matters. Innocence can coexist with wisdom. Play can coexist with responsibility. Reconnect. Remember. Bring that joy forward.",
        "love": "In love, the Six of Cups indicates reconnecting with past loves, childhood sweethearts, or relationships that feel familiar and safe. If you're single, you may meet someone from your past, or attract partners who feel like home. For those in relationships, this card suggests reconnecting with the playfulness of early love, revisiting happy memories, or creating traditions together. The Six of Cups reminds you: love doesn't have to be complicated. Sometimes the simplest connections are the deepest.",
        "career": "Professionally, the Six of Cups indicates returning to previous work, reconnecting with former colleagues, or work that evokes nostalgia. This card supports creative work, roles involving children, or careers that honour tradition. The Six of Cups reminds you: your past experience matters. Bring it forward. Don't dismiss what you've learned. Wisdom accumulates.",
        "health": "The Six of Cups governs emotional health through nostalgia—finding comfort in memories, reconnecting with childhood joys, or healing through simplicity. This card supports practices that reconnect you with play—creative hobbies, time with children, or simply allowing yourself to be silly. The Six of Cups reminds you: joy is medicine. Access it."
      },
      "reversed": {
        "subtitle": "Stuck in the past, unrealistic expectations, moving forward, leaving home",
        "general": "Reversed, the Six of Cups indicates being stuck in nostalgia—living in the past, unrealistic expectations based on memory, or refusing to grow up. Alternatively, it can indicate leaving the past behind—moving away, growing beyond childhood, or releasing old patterns. The reversed Six of Cups asks: are you romanticising the past? Are you using memory to avoid the present? This card reminds you: the past shaped you. It doesn't define you. Honour it. Then move forward. Growth requires leaving some things behind.",
        "love": "In love, this reversal indicates being stuck on ex-partners, idealising past relationships, or expecting current partners to match impossible memories. If you're single, you may be unavailable because you're living in the past. For those in relationships, the reversed Six of Cups suggests working through unrealistic expectations, accepting that relationships evolve, or creating new memories rather than clinging to old ones. This card reminds you: love exists in the present. Live there.",
        "career": "Career-wise, reversed Six of Cups indicates clinging to past careers, romanticising old jobs, or refusing to adapt to change. This card asks: are you growing, or stagnating? Your past experience matters, but it doesn't limit you. Learn. Adapt. Move forward. Your career is evolving. Evolve with it.",
        "health": "Reversed, this card indicates health issues from living in the past—ignoring current needs, romanticising old health patterns, or refusing to adapt to new realities. The reversed Six of Cups asks: are you caring for your current body, or the body you used to have? Accept where you are. Work from there. Your health is now. Honour it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Seven of Cups indicates clarity after confusion—making choices, seeing through illusions, or focusing on what matters. You're cutting through the noise. The reversed Seven of Cups asks: what have you chosen? What illusions have you released? This card reminds you: clarity comes through commitment. Choose. Then commit. The other paths will still be there if you need them. But you can't walk them all. Walk one. Fully.",
        "love": "In love, this reversal indicates making relationship choices—committing to one person, ending situationships, or choosing yourself. If you're single, you may be ready for something real after dating around. For those in relationships, the reversed Seven of Cups suggests making commitment decisions, ending fantasies, or focusing on your actual relationship. This card reminds you: love requires choice. Choose. Then invest.",
        "career": "Career-wise, reversed Seven of Cups indicates making career decisions—choosing a path, focusing on one opportunity, or ending the search. This card supports committing to a direction after a period of exploration. You've learned what you want. Now pursue it. Focus creates success.",
        "health": "Reversed, this card indicates clarity about health choices—choosing an approach, committing to a plan, or ending the search for perfect solutions. The reversed Seven of Cups reminds you: consistency beats perfection. Choose what works. Do it. Your health benefits from commitment. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Eight of Cups depicts a figure walking away from eight stacked cups, heading toward mountains under a moonlit sky. The cups are intact, but the figure leaves them. The Eight of Cups represents walking away from what no longer serves you—even when it looks good from the outside. This card asks: what are you outgrowing? What looks successful but feels empty? The Eight of Cups reminds you: leaving isn't failure. It's growth. Sometimes the bravest thing is to walk away. Trust the journey. What you seek is ahead, not behind. Keep walking.",
        "love": "In love, the Eight of Cups indicates leaving relationships that no longer fulfil you—even when they look good from the outside. If you're single, you may be walking away from patterns that don't serve you. For those in relationships, this card suggests recognising emotional emptiness, or making the difficult choice to leave. The Eight of Cups reminds you: staying in unfulfilling love serves no one. Walk away. Better love awaits.",
        "career": "Professionally, the Eight of Cups indicates leaving careers that no longer fulfil you—successful on paper, empty in practice. This card supports career changes, sabbaticals, or walking away from security for meaning. The Eight of Cups reminds you: your career should serve your life. If it doesn't, change it. Walk away. Meaning awaits.",
        "health": "The Eight of Cups governs leaving unhealthy patterns—habits, relationships, or beliefs that undermine wellbeing. This card supports walking away from what harms you, even when it's comfortable. The Eight of Cups reminds you: your health deserves priority. Leave what harms it. Walk toward healing."
      },
      "reversed": {
        "subtitle": "Returning, fear of leaving, stagnation, unfinished business, coming back",
        "general": "Reversed, the Eight of Cups indicates fear of leaving—knowing you should walk away but staying anyway. Alternatively, it can indicate returning to what you left, or unfinished business calling you back. The reversed Eight of Cups asks: what's keeping you stuck? Fear? Obligation? Comfort? This card reminds you: staying when you should leave creates suffering. Leaving when you should return creates regret. Discernment matters. Choose wisely. Then commit.",
        "love": "In love, this reversal indicates staying in unfulfilling relationships out of fear, or returning to ex-partners. If you're single, you may be afraid to leave patterns that don't serve you. For those in relationships, the reversed Eight of Cups suggests recognising you're staying for wrong reasons, or working through whether to leave or commit. This card asks: are you choosing from fear, or love? Choose love.",
        "career": "Career-wise, reversed Eight of Cups indicates staying in unfulfilling work out of fear, or returning to previous careers. This card asks: are you choosing from fear, or genuine desire? If you're staying from fear, examine it. If you're returning from genuine desire, commit. Your career deserves conscious choices. Make them.",
        "health": "Reversed, this card indicates fear of leaving unhealthy patterns, or returning to old habits after progress. The reversed Eight of Cups asks: what's keeping you stuck? Address it. Your health deserves conscious choices. Make them. Change is possible. Choose it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Nine of Cups shows a satisfied figure seated before nine cups arranged in an arc. The figure's posture says: 'I have enough.' The Nine of Cups is called the 'wish card'—emotional fulfilment, satisfaction, and having what you need. This card asks you to appreciate what you have. Not everything needs to be earned. Some things are gifts. The Nine of Cups reminds you: contentment isn't complacency. It's gratitude. Enjoy what you've built. Celebrate what you have. You've earned this satisfaction.",
        "love": "In love, the Nine of Cups indicates emotional satisfaction—feeling loved, appreciated, and content in your relationship. If you're single, this card suggests you're happy within yourself, which attracts healthy partners. For those in relationships, the Nine of Cups indicates a phase of contentment, wishes fulfilled, or simply enjoying each other. This card reminds you: love should feel good. If it does, appreciate it. Don't take it for granted.",
        "career": "Professionally, the Nine of Cups indicates career satisfaction—achieving goals, feeling fulfilled, or having what you need. This card celebrates your accomplishments. You've worked hard. Enjoy the results. The Nine of Cups also reminds you: satisfaction isn't permanent. Maintain it. Continue growing. But also: rest. You've earned it.",
        "health": "The Nine of Cups governs emotional and physical wellbeing—feeling healthy, satisfied with your body, or achieving health goals. This card celebrates your progress. You've worked hard. Enjoy your health. The Nine of Cups reminds you: health isn't a destination. It's a practice. Maintain it. But also: appreciate where you are. You're doing well."
      },
      "reversed": {
        "subtitle": "Dissatisfaction, excess, materialism, inner emptiness, greed",
        "general": "Reversed, the Nine of Cups indicates dissatisfaction despite having enough—greed, excess, or inner emptiness despite external success. Alternatively, it can indicate modest satisfaction—having enough but not acknowledging it. The reversed Nine of Cups asks: what would satisfy you? Is it more stuff, or something deeper? This card reminds you: contentment comes from within. No amount of external success fills internal emptiness. Look inward. What do you truly need? Find that.",
        "love": "In love, this reversal indicates dissatisfaction despite having a good relationship—always wanting more, or feeling empty despite love. If you're single, you may be seeking external validation through relationships. For those in relationships, the reversed Nine of Cups suggests working through dissatisfaction, appreciating what you have, or recognising that no relationship fills internal emptiness. This card reminds you: love complements wholeness. It doesn't create it.",
        "career": "Career-wise, reversed Nine of Cups indicates career dissatisfaction despite success—always wanting more, or feeling empty despite achievements. This card asks: what would truly satisfy you? More money won't fix it. What will? Address it. Your career deserves meaning. Find it.",
        "health": "Reversed, this card indicates health dissatisfaction—never feeling healthy enough, or using health as a source of identity rather than wellbeing. The reversed Nine of Cups asks: are you caring for your health, or performing it? Address it. Health is for living. Not for showing off."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Ten of Cups depicts a happy family—parents and children—standing beneath a rainbow of ten cups. A home is in the background. The Ten of Cups represents emotional fulfilment, family harmony, and the joy of belonging. This is the culmination of the Cups suit—love realised, family created, emotional completion. The Ten of Cups asks you to appreciate your tribe. Who loves you? Who do you love? This card reminds you: happiness isn't solitary. It's shared. Build your family—biological or chosen. Nurture it. Celebrate it. This is what matters.",
        "love": "In love, the Ten of Cups is one of the most positive cards—long-term commitment, marriage, family, or deep emotional fulfilment. If you're single, this card suggests you're ready for lasting love. For those in relationships, the Ten of Cups indicates commitment, family planning, or simply deep satisfaction. This card reminds you: love builds families. Choose yours wisely. Nurture it. This is your legacy.",
        "career": "Professionally, the Ten of Cups indicates work that supports your family life—flexible schedules, meaningful work, or careers that align with your values. This card reminds you: your career should support your life, not consume it. Build work that allows you to be present for family. Success isn't just professional. It's personal too.",
        "health": "The Ten of Cups governs family health—generational patterns, supporting each other's wellbeing, or creating healthy family traditions. This card reminds you: your health affects your family. Your family's health affects you. Support each other. Build healthy traditions together. This is your legacy."
      },
      "reversed": {
        "subtitle": "Family conflict, broken homes, disconnection, unrealistic expectations, isolation",
        "general": "Reversed, the Ten of Cups indicates family conflict, disconnection, or unrealistic expectations about happiness. The rainbow is broken; the family is scattered. The reversed Ten of Cups asks: what's disrupting your harmony? What expectations aren't being met? This card reminds you: families aren't perfect. Conflict is normal. What matters is repair. Work through it. Reconnect. Or accept that some families are chosen, not given. Build your tribe. However it looks.",
        "love": "In love, this reversal indicates family conflict affecting relationships, or unrealistic expectations about what love should look like. If you're single, you may be held back by family patterns or expectations. For those in relationships, the reversed Ten of Cups suggests working through family issues, adjusting expectations, or recognising that perfection isn't the goal. This card reminds you: love survives imperfection. Work through it. Together.",
        "career": "Career-wise, reversed Ten of Cups indicates family affecting career—obligations limiting options, or work-family conflict. This card asks: how can you balance both? What adjustments are needed? Your career and family both matter. Find balance. It's possible.",
        "health": "Reversed, this card indicates family health issues—generational patterns affecting wellbeing, or family conflict impacting health. The reversed Ten of Cups asks: what patterns are you repeating? What can you change? Your health is your responsibility. Break harmful cycles. Build healthy ones. Your family deserves it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Page of Cups shows a young person holding a cup, a fish emerging from it. The Page gazes at the fish with curiosity and delight. The Page of Cups represents new emotional experiences, creative inspiration, and intuitive messages. This card asks you to approach emotions with curiosity. What are you feeling? What is your intuition telling you? The Page of Cups reminds you: you don't need to have all the answers. Stay curious. Stay open. New feelings are emerging. Explore them. Creativity is calling. Answer it.",
        "love": "In love, the Page of Cups indicates new romantic feelings, crushes, or emotional exploration. If you're single, this card suggests you're open to new feelings, or someone may express interest in you. For those in relationships, the Page of Cups indicates renewed playfulness, expressing feelings, or exploring emotional intimacy. This card reminds you: love benefits from curiosity. Stay interested. Stay open. Feelings are evolving. Explore them together.",
        "career": "Professionally, the Page of Cups indicates creative opportunities, intuitive insights about career, or exploring new directions. This card supports following creative inspiration, trusting your intuition about work, or learning new skills. The Page of Cups reminds you: you don't need to know everything. Stay curious. Learn. Grow. Your career is evolving. Explore it.",
        "health": "The Page of Cups governs emotional health exploration—learning about your feelings, intuitive health insights, or creative approaches to wellbeing. This card supports exploring what works for your body, trusting your intuition about health, or approaching wellbeing with curiosity. The Page of Cups reminds you: your body speaks. Listen. Learn. Your health is evolving. Explore it."
      },
      "reversed": {
        "subtitle": "Emotional immaturity, creative blocks, ignoring intuition, moodiness, disappointment",
        "general": "Reversed, the Page of Cups indicates emotional immaturity—moodiness, ignoring intuition, or creative blocks. The fish is swimming away; the message is missed. The reversed Page of Cups asks: are you taking your feelings seriously? Are you ignoring intuitive messages? This card reminds you: emotions aren't weaknesses. They're information. Pay attention. Grow up. Your feelings matter. Handle them maturely.",
        "love": "In love, this reversal indicates emotional immaturity—moodiness, game-playing, or ignoring feelings. If you're single, you may be attracting immature partners, or not taking feelings seriously. For those in relationships, the reversed Page of Cups suggests working through emotional immaturity, communicating feelings clearly, or taking each other's emotions seriously. This card reminds you: love requires emotional maturity. Grow into it.",
        "career": "Career-wise, reversed Page of Cups indicates creative blocks, ignoring intuition about work, or emotional immaturity at work. This card asks: are you taking your career seriously? Are you listening to your intuition? Address it. Your career deserves maturity. Give it.",
        "health": "Reversed, this card indicates ignoring health intuition, emotional approaches to health feeling immature, or moodiness affecting wellbeing. The reversed Page of Cups asks: are you taking your health seriously? Are you listening to your body? Address it. Your health deserves maturity. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Knight of Cups rides forward holding a cup, dressed in flowing robes, eyes lifted as if following a vision. The Knight of Cups represents romantic pursuit, following your heart, and idealistic action. This card asks you to pursue what you love. Not logically. Not practically. What calls to your heart? The Knight of Cups reminds you: romance isn't frivolous. It's essential. Follow your heart. Pursue your dreams. Idealism has its place. Let it guide you. But also: keep your feet on the ground. Dreams need action.",
        "love": "In love, the Knight of Cups indicates romantic pursuit—someone pursuing you, or you pursuing love. If you're single, this card suggests romance is coming—someone charming, idealistic, following their heart. For those in relationships, the Knight of Cups indicates renewed romance, grand gestures, or following your heart together. This card reminds you: love benefits from romance. Pursue each other. Keep the magic alive.",
        "career": "Professionally, the Knight of Cups indicates following your heart career-wise—pursuing creative work, idealistic projects, or work that feels like a calling. This card supports taking action on dreams, pursuing meaningful work, or bringing creativity to your career. The Knight of Cups reminds you: your career can be both practical and passionate. Pursue both.",
        "health": "The Knight of Cups governs pursuing health with heart—following intuitive approaches, creative wellness practices, or approaching health romantically. This card supports finding health practices you love, pursuing wellbeing with passion, or following your heart about what works. The Knight of Cups reminds you: health benefits from joy. Find practices you love. Pursue them."
      },
      "reversed": {
        "subtitle": "Disappointment, unrealistic, jealousy, moodiness, broken promises, manipulation",
        "general": "Reversed, the Knight of Cups indicates disappointment in love, unrealistic expectations, or emotional manipulation. The Knight's horse is rearing; the cup is spilling. The reversed Knight of Cups asks: are you being realistic? Are you following your heart, or your fantasies? This card reminds you: idealism without grounding creates disappointment. Be romantic, but also be real. Promises mean nothing without action. Demand both.",
        "love": "In love, this reversal indicates romantic disappointment, unrealistic expectations, or emotional manipulation. If you're single, you may be attracted to charming but unreliable partners. For those in relationships, the reversed Knight of Cups suggests working through disappointment, adjusting expectations, or recognising manipulation. This card reminds you: love requires both romance and reality. Demand both.",
        "career": "Career-wise, reversed Knight of Cups indicates pursuing unrealistic career dreams, disappointment in creative work, or being charming but unreliable. This card asks: are your career goals realistic? Are you following through? Address it. Dreams need action. Give it.",
        "health": "Reversed, this card indicates unrealistic health expectations, disappointment in health approaches, or pursuing wellness inconsistently. The reversed Knight of Cups asks: are your health goals realistic? Are you following through? Address it. Health requires consistency. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Queen of Cups sits on a throne by the sea, holding a ornate cup, gazing at it with deep intuition. The Queen of Cups represents emotional maturity, compassion, and nurturing wisdom. She feels deeply but isn't overwhelmed. She cares for others without losing herself. The Queen of Cups asks you to embody these qualities. What needs your compassion? Who needs your care? The Queen of Cups reminds you: emotional strength isn't hardness. It's the capacity to feel deeply while remaining centred. Be compassionate. Be intuitive. Be nurturing. But also: nurture yourself. You matter too.",
        "love": "In love, the Queen of Cups indicates deep emotional connection, nurturing partnerships, or embodying compassionate love. If you're single, this card suggests you're ready for mature love, or attracting partners who appreciate emotional depth. For those in relationships, the Queen of Cups indicates nurturing each other, deep empathy, or emotional security. This card reminds you: love benefits from emotional maturity. Embody it. Share it.",
        "career": "Professionally, the Queen of Cups indicates careers involving care—healthcare, counselling, teaching, or any work requiring emotional intelligence. This card supports leading with compassion, trusting your intuition about work, or creating emotionally safe workplaces. The Queen of Cups reminds you: your emotional intelligence is an asset. Use it.",
        "health": "The Queen of Cups governs intuitive health—listening to your body, nurturing your wellbeing, or approaching health with compassion. This card supports self-care practices, emotional approaches to health, or trusting your intuition about what works. The Queen of Cups reminds you: your body deserves compassion. Give it. You're worth nurturing."
      },
      "reversed": {
        "subtitle": "Emotional insecurity, codependency, martyrdom, manipulation, boundaries needed",
        "general": "Reversed, the Queen of Cups indicates emotional insecurity, codependency, or nurturing to the point of martyrdom. The Queen's cup is overturned; her intuition is clouded. The reversed Queen of Cups asks: are you nurturing others at your own expense? Are you using emotions to manipulate, or being manipulated? This card reminds you: compassion without boundaries isn't compassion. It's self-destruction. Set boundaries. Nurture yourself. Your feelings matter too.",
        "love": "In love, this reversal indicates codependency, emotional insecurity, or nurturing to the point of losing yourself. If you're single, you may be attracting partners who need 'fixing,' or using care to earn love. For those in relationships, the reversed Queen of Cups suggests working through codependency, setting boundaries, or recognising manipulation. This card reminds you: love requires two whole people. Be whole. Demand wholeness.",
        "career": "Career-wise, reversed Queen of Cups indicates emotional burnout from caregiving, codependency at work, or using emotions manipulatively. This card asks: are you nurturing others at your own expense? Are boundaries needed? Address it. Your career deserves sustainability. Create it.",
        "health": "Reversed, this card indicates health issues from emotional neglect of self, codependency affecting wellbeing, or using health to manipulate. The reversed Queen of Cups asks: are you caring for yourself, or only others? Address it. Your health matters. Prioritise it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the King of Cups indicates emotional manipulation, moodiness, or being controlled by feelings. The King's throne is tipping; the sea is rough. The reversed King of Cups asks: are you using emotions to control others? Are you being controlled by your feelings? This card reminds you: emotional maturity requires honesty. Stop manipulating. Stop suppressing. Feel your feelings. But don't weaponise them. Grow up. Lead yourself first.",
        "love": "In love, this reversal indicates emotional manipulation, moodiness, or coldness. If you're single, you may be attracting emotionally unavailable partners, or being emotionally unavailable yourself. For those in relationships, the reversed King of Cups suggests working through emotional manipulation, moodiness, or control issues. This card reminds you: love requires emotional honesty. Be honest. Demand honesty.",
        "career": "Career-wise, reversed King of Cups indicates emotional manipulation at work, moodiness affecting leadership, or being controlled by feelings. This card asks: are you leading with emotional intelligence, or emotional manipulation? Address it. Your career deserves integrity. Give it.",
        "health": "Reversed, this card indicates health issues from emotional volatility, using health to manipulate, or emotional suppression affecting wellbeing. The reversed King of Cups asks: are you managing your emotions maturely? Address it. Your health deserves honesty. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Ace of Pentacles shows a hand emerging from a cloud, holding a large coin surrounded by lush garden and mountains beyond. This is the seed of material prosperity—new opportunities, financial beginnings, and the potential for abundance. The Ace of Pentacles asks you to recognise opportunity when it appears. What seeds are you being offered? Plant them. The Ace of Pentacles reminds you: prosperity begins with a single step. Accept the opportunity. Invest wisely. Build steadily. Abundance is possible. Begin.",
        "love": "In love, the Ace of Pentacles indicates building love on solid foundations—stable relationships, practical expressions of love, or new relationships with long-term potential. If you're single, this card suggests meeting someone through work or practical matters, or attracting partners who offer stability. For those in relationships, the Ace of Pentacles indicates building security together, practical expressions of love, or financial planning as a couple. This card reminds you: love benefits from stability. Build it together.",
        "career": "Professionally, the Ace of Pentacles is one of the strongest cards for new opportunities—job offers, business ventures, or financial prospects. This card supports taking calculated risks, investing in your skills, or starting new projects. The Ace of Pentacles reminds you: opportunity is here. Recognise it. Seize it. Build from it. Your career deserves investment. Give it.",
        "health": "The Ace of Pentacles governs physical health beginnings—starting new routines, investing in wellbeing, or opportunities for healing. This card supports practical health approaches—nutrition, exercise, medical care. The Ace of Pentacles reminds you: your body is your foundation. Invest in it. Health is wealth. Build it."
      },
      "reversed": {
        "subtitle": "Missed opportunities, poor financial decisions, greed, lack of planning, scarcity",
        "general": "Reversed, the Ace of Pentacles indicates missed opportunities, poor financial decisions, or grasping for prosperity without planning. The coin is dropped; the opportunity is lost. The reversed Ace of Pentacles asks: what opportunities are you missing? Are you being greedy, or too cautious? This card reminds you: prosperity requires both opportunity and wisdom. Don't grasp. Don't ignore. Discern. Plan. Then act. Abundance is still possible. Approach it wisely.",
        "love": "In love, this reversal indicates relationships built on unstable foundations—financial stress affecting love, or attracting partners for wrong reasons. If you're single, you may be focusing too much on material aspects of partners. For those in relationships, the reversed Ace of Pentacles suggests working through financial stress, or recognising that love can't be bought. This card reminds you: love requires more than material security. Build both.",
        "career": "Career-wise, reversed Ace of Pentacles indicates missed opportunities, poor financial decisions, or greed affecting career. This card asks: are you seeing opportunities? Are you making wise decisions? Address it. Your career deserves smart choices. Make them.",
        "health": "Reversed, this card indicates neglecting physical health, poor health investments, or greed overriding wellbeing. The reversed Ace of Pentacles asks: are you investing in your health? Are you making wise choices? Address it. Your body deserves investment. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Two of Pentacles depicts a figure juggling two coins connected by an infinity loop, ships tossing on waves in the background. The Two of Pentacles represents balancing resources, adaptability, and managing competing priorities. This card asks you to find rhythm in the juggling. What needs your attention? What can wait? The Two of Pentacles reminds you: balance isn't static. It's dynamic. You're not meant to hold everything perfectly. You're meant to flow. Adapt. Prioritise. Keep moving. You can handle this.",
        "love": "In love, the Two of Pentacles indicates balancing relationship with other priorities—work, family, or personal goals. If you're single, this card suggests dating while managing other life demands. For those in relationships, the Two of Pentacles indicates working together to balance finances, time, or responsibilities. This card reminds you: love requires attention. Make time. Prioritise each other. Balance is possible.",
        "career": "Professionally, the Two of Pentacles indicates managing multiple projects, balancing work with life, or adapting to changing circumstances. This card supports flexibility, time management, and prioritising effectively. The Two of Pentacles reminds you: you can't do everything at once. Prioritise. Adapt. Keep moving. Success comes from consistency, not perfection.",
        "health": "The Two of Pentacles governs balancing health with life demands—making time for self-care, managing energy, or adapting health routines to changing circumstances. This card supports flexible health approaches, consistent but not perfect practices. The Two of Pentacles reminds you: health doesn't require perfection. It requires consistency. Find your rhythm. Maintain it."
      },
      "reversed": {
        "subtitle": "Imbalance, overwhelmed, poor time management, dropping balls, financial stress",
        "general": "Reversed, the Two of Pentacles indicates losing the juggling act—overwhelmed, dropping balls, or financial stress from poor management. The coins are falling; the rhythm is lost. The reversed Two of Pentacles asks: what are you taking on that you can't handle? What needs to be dropped? This card reminds you: you can't do everything. Choose. Prioritise. Let go of what doesn't matter. Balance is restored through subtraction, not addition. Simplify. Breathe. Begin again.",
        "love": "In love, this reversal indicates relationship stress from imbalance—work consuming relationship time, financial stress affecting love, or feeling overwhelmed by relationship demands. If you're single, you may be too overwhelmed to date. For those in relationships, the reversed Two of Pentacles suggests working through imbalance, reprioritising, or recognising when too much is too much. This card reminds you: love deserves attention. Make space for it.",
        "career": "Career-wise, reversed Two of Pentacles indicates burnout from overwork, poor time management, or financial stress from mismanagement. This card asks: what can you drop? What needs delegating? Address it. Your career deserves sustainability. Create it.",
        "health": "Reversed, this card indicates health suffering from imbalance—no time for self-care, stress affecting wellbeing, or inconsistent health practices. The reversed Two of Pentacles asks: what health priorities are you dropping? Address it. Your health deserves consistency. Create it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Three of Pentacles shows a stonemason working in a cathedral, two figures observing—likely the architect and a cleric. The Three of Pentacles represents skilled work, collaboration, and building something lasting. This card asks you to honour your craft. What are you building? Who are you building with? The Three of Pentacles reminds you: great work requires both skill and collaboration. Learn from masters. Work with others. Build something that outlasts you. Your craft matters. Honour it.",
        "love": "In love, the Three of Pentacles indicates building relationships through teamwork—working together on shared goals, learning from each other, or building a life together. If you're single, this card suggests meeting someone through work or shared projects. For those in relationships, the Three of Pentacles indicates collaborative problem-solving, building security together, or learning from each other. This card reminds you: love is built. Work at it. Together.",
        "career": "Professionally, the Three of Pentacles indicates collaborative projects, skill development, or recognition for your craftsmanship. This card supports learning from mentors, working in teams, or building expertise. The Three of Pentacles reminds you: your skills matter. Develop them. Share them. Build something lasting. Your career is a craft. Honour it.",
        "health": "The Three of Pentacles governs building health through collaboration—working with professionals, learning healthy habits, or building sustainable routines. This card supports skilled health approaches—physical therapy, training with experts, or learning from those who know. The Three of Pentacles reminds you: health is built. Work at it. With support."
      },
      "reversed": {
        "subtitle": "Lack of teamwork, poor craftsmanship, ego clashes, lack of recognition, cutting corners",
        "general": "Reversed, the Three of Pentacles indicates poor collaboration, ego clashes, or cutting corners on your work. The cathedral isn't being built properly; the team isn't working together. The reversed Three of Pentacles asks: are you working well with others? Are you honouring your craft? This card reminds you: great work requires humility. Check your ego. Collaborate. Do quality work. Your reputation matters. Protect it.",
        "love": "In love, this reversal indicates relationship teamwork issues—ego clashes, not working together, or one person not pulling their weight. If you're single, you may be attracting partners who don't collaborate well. For those in relationships, the reversed Three of Pentacles suggests working through collaboration issues, checking egos, or recognising when you're not working as a team. This card reminds you: love requires teamwork. Work at it. Together.",
        "career": "Career-wise, reversed Three of Pentacles indicates team conflicts, poor work quality, or lack of recognition. This card asks: are you collaborating well? Are you honouring your craft? Address it. Your career deserves quality work. Give it.",
        "health": "Reversed, this card indicates health issues from poor collaboration with professionals, cutting corners on health, or ego preventing learning. The reversed Three of Pentacles asks: are you working with your health team? Are you honouring your body? Address it. Your health deserves quality care. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Four of Pentacles depicts a figure clutching four coins—one on head, one in arms, two under feet—sitting on a throne, unwilling to let go. The Four of Pentacles represents financial security, conservation, and the desire to hold onto what you have. This card asks you to examine your relationship with security. Are you protecting wisely, or hoarding from fear? The Four of Pentacles reminds you: security matters. But so does flow. Money wants to move. Resources want to circulate. Hold wisely. Share appropriately. Security isn't scarcity. Know the difference.",
        "love": "In love, the Four of Pentacles indicates building security together, or possessiveness affecting relationships. If you're single, you may be holding onto past relationships, or being too controlling in dating. For those in relationships, the Four of Pentacles indicates financial planning together, or working through possessiveness. This card reminds you: love requires both security and freedom. Balance them.",
        "career": "Professionally, the Four of Pentacles indicates financial stability, saving for the future, or being conservative with career risks. This card supports building security, but warns against holding on too tightly to positions or opportunities. The Four of Pentacles reminds you: security is important. But growth requires some risk. Balance them.",
        "health": "The Four of Pentacles governs health conservation—protecting your energy, being conservative with health resources, or holding onto health routines. This card supports consistent health practices, but warns against rigidity. The Four of Pentacles reminds you: health requires both consistency and flexibility. Balance them."
      },
      "reversed": {
        "subtitle": "Greed, materialism, financial insecurity, letting go, generosity needed",
        "general": "Reversed, the Four of Pentacles indicates greed, financial insecurity, or the need to let go. The coins are falling; the grip is loosening. The reversed Four of Pentacles asks: are you holding on too tightly? Are you being greedy, or acting from scarcity? This card reminds you: security comes from wise management, not hoarding. Let go. Share. Trust that more will come. Abundance flows. Don't block it.",
        "love": "In love, this reversal indicates possessiveness, greed for affection, or financial insecurity affecting relationships. If you're single, you may be holding onto love too tightly, or attracting partners with similar issues. For those in relationships, the reversed Four of Pentacles suggests working through possessiveness, financial insecurity, or learning to share. This card reminds you: love grows when shared. Let it flow.",
        "career": "Career-wise, reversed Four of Pentacles indicates greed, financial insecurity, or being too conservative. This card asks: are you holding on too tightly? Are you letting fear drive decisions? Address it. Your career deserves wise risk-taking. Give it.",
        "health": "Reversed, this card indicates health issues from rigidity, greed overriding wellbeing, or financial insecurity preventing care. The reversed Four of Pentacles asks: are you being too rigid? Are you letting fear drive health decisions? Address it. Your health deserves flexibility. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Five of Pentacles shows two figures walking in snow outside a lit church window—one on crutches, one barefoot. They don't see the sanctuary available. The Five of Pentacles represents hardship, financial struggle, and feeling abandoned. This card asks you to recognise available help. What support is available that you're not seeing? The Five of Pentacles reminds you: hardship is temporary. Help exists. You're not as alone as you feel. Reach out. Accept help. This will pass. Keep walking. Sanctuary is available.",
        "love": "In love, the Five of Pentacles indicates relationship hardship—financial stress affecting love, feeling abandoned, or struggling together. If you're single, you may feel unlovable due to circumstances. For those in relationships, the Five of Pentacles indicates working through hardship together, or recognising when external support is needed. This card reminds you: love survives hardship. Together. Seek help. You're not alone.",
        "career": "Professionally, the Five of Pentacles indicates financial hardship, job loss, or career struggles. This card asks you to recognise available support—unemployment benefits, networking, or retraining. The Five of Pentacles reminds you: career hardship is temporary. Help exists. Keep going. Better times come.",
        "health": "The Five of Pentacles governs health hardship—illness, inability to afford care, or feeling abandoned by the medical system. This card asks you to seek available help—community resources, support groups, or alternative care. The Five of Pentacles reminds you: health struggles are temporary. Help exists. Keep going. Healing is possible."
      },
      "reversed": {
        "subtitle": "Recovery, improvement, seeking help, ending hardship, hope returning",
        "general": "Reversed, the Five of Pentacles indicates emerging from hardship—recovery beginning, help accepted, or hope returning. The figures are turning toward the church; sanctuary is being seen. The reversed Five of Pentacles asks: what help are you ready to accept? What recovery is beginning? This card reminds you: hardship ends. Recovery begins. Accept help. Keep going. Better times are here.",
        "love": "In love, this reversal indicates recovering from relationship hardship—financial stress easing, feeling less abandoned, or working through struggles. If you're single, you may be recovering from feeling unlovable. For those in relationships, the reversed Five of Pentacles suggests recovery together, accepting help, or hope returning. This card reminds you: love survives hardship. You're emerging. Keep going.",
        "career": "Career-wise, reversed Five of Pentacles indicates career recovery—finding work, financial improvement, or hope returning. This card supports accepting help, networking, or rebuilding. The reversed Five of Pentacles reminds you: career hardship ends. Recovery begins. Keep going.",
        "health": "Reversed, this card indicates health recovery—improvement beginning, treatment working, or hope returning. The reversed Five of Pentacles reminds you: health struggles end. Healing begins. Keep going. Accept help. You're emerging."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Six of Pentacles depicts a wealthy merchant distributing coins to beggars, scales in hand symbolising balance. The Six of Pentacles represents generosity, reciprocity, and the flow of resources. This card asks you to examine your relationship with giving and receiving. Are you only giving? Only receiving? The Six of Pentacles reminds you: abundance flows. Give generously. Receive graciously. Both are necessary. Both are sacred. Find balance. Share what you have. Accept what's offered. The cycle continues.",
        "love": "In love, the Six of Pentacles indicates balanced giving and receiving—mutual support, generosity without martyrdom. If you're single, this card suggests attracting partners who understand reciprocity. For those in relationships, the Six of Pentacles indicates financial generosity together, or working through imbalances in giving. This card reminds you: love requires balance. Give. Receive. Both matter.",
        "career": "Professionally, the Six of Pentacles indicates fair compensation, generous leadership, or charitable work. This card supports negotiating fair pay, sharing resources with colleagues, or balancing giving with receiving. The Six of Pentacles reminds you: your work deserves fair compensation. Demand it. Share generously. But also: receive graciously.",
        "health": "The Six of Pentacles governs balanced health investment—giving to your body while receiving its gifts, or balancing self-care with caring for others. This card supports fair health compensation for professionals, or accepting health help graciously. The Six of Pentacles reminds you: your health deserves investment. Give it. Receive its gifts. Both matter."
      },
      "reversed": {
        "subtitle": "Strings attached, unequal giving, charity with conditions, debt, power dynamics",
        "general": "Reversed, the Six of Pentacles indicates imbalanced giving—strings attached to generosity, unequal relationships, or power dynamics in giving. The scales are tipped; the balance is lost. The reversed Six of Pentacles asks: are you giving to control? Receiving without gratitude? This card reminds you: true generosity has no strings. True receiving has gratitude. Restore balance. Give freely. Receive gratefully. Or don't give at all.",
        "love": "In love, this reversal indicates imbalanced giving—one person always giving, the other always receiving, or generosity with strings attached. If you're single, you may be attracting unequal dynamics. For those in relationships, the reversed Six of Pentacles suggests working through imbalance, recognising power dynamics, or learning to give and receive equally. This card reminds you: love requires balance. Restore it.",
        "career": "Career-wise, reversed Six of Pentacles indicates unfair compensation, strings attached to opportunities, or power dynamics in workplace generosity. This card asks: are you being fairly compensated? Are you giving to control? Address it. Your career deserves fairness. Demand it.",
        "health": "Reversed, this card indicates health issues from imbalanced care—always caring for others, never receiving, or health help with strings attached. The reversed Six of Pentacles asks: are you balancing giving and receiving? Address it. Your health deserves balance. Create it."
      }
    }
  },
  {
    ...
    "meanings": {
      "upright": {
        ...
        "general": "The Seven of Pentacles shows a farmer leaning on a hoe, contemplating seven pentacles growing on a bush. The harvest isn't ready. The Seven of Pentacles represents patience, long-term investment, and trusting the process. This card asks you: what are you cultivating? Are you willing to wait for it to grow? The Seven of Pentacles reminds you: some things can't be rushed. Seeds need time. Investments mature. Trust the process. Keep tending. The harvest will come. Patience is wisdom.",
        "love": "In love, the Seven of Pentacles indicates patient relationship building—investing time, waiting for love to deepen, or long-term commitment. If you're single, this card suggests patience in dating, not rushing connections. For those in relationships, the Seven of Pentacles indicates working through slow periods, investing in long-term growth, or waiting for relationship milestones. This card reminds you: love grows slowly. Be patient. Keep tending.",
        "career": "Professionally, the Seven of Pentacles indicates long-term career investment—waiting for promotions, building businesses slowly, or patient skill development. This card supports staying the course, trusting long-term plans, or recognising that success takes time. The Seven of Pentacles reminds you: your career is a marathon. Pace yourself. Keep going. Success will come.",
        "health": "The Seven of Pentacles governs patient health investment—long-term health goals, trusting slow healing, or consistent health practices. This card supports patience with health progress, recognising that healing takes time. The Seven of Pentacles reminds you: health grows slowly. Be patient. Keep tending. Results will come."
      },
      "reversed": {
        "subtitle": "Impatience, lack of reward, poor investment, giving up too soon, frustration",
        "general": "Reversed, the Seven of Pentacles indicates impatience, lack of reward for effort, or considering giving up. The farmer is frustrated; the harvest isn't coming fast enough. The reversed Seven of Pentacles asks: are you expecting too much too soon? Are you giving up before the harvest? This card reminds you: some things take time. But also: is this investment worth it? Examine. Decide. Then commit—or walk away. Don't waste your life on barren soil.",
        "love": "In love, this reversal indicates impatience with relationship growth, feeling unrewarded for effort, or considering giving up. If you're single, you may be giving up on dating too soon. For those in relationships, the reversed Seven of Pentacles suggests working through impatience, examining whether the relationship is worth the wait, or recognising when it's time to walk away. This card reminds you: love deserves patience. But also: don't waste your heart on barren soil.",
        "career": "Career-wise, reversed Seven of Pentacles indicates career impatience, feeling unrewarded, or considering giving up. This card asks: is this career investment worth it? Are you giving up too soon? Address it. Your career deserves wise investment. Make it.",
        "health": "Reversed, this card indicates health impatience, feeling unrewarded for health efforts, or giving up too soon. The reversed Seven of Pentacles asks: are you expecting too much too soon? Are you giving up? Address it. Your health deserves patience. But also: examine your approach. Adjust if needed. Keep going."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Eight of Pentacles indicates poor craftsmanship, cutting corners, or lack of motivation. The apprentice isn't trying; the pentacles are poorly made. The reversed Eight of Pentacles asks: are you honouring your craft? Are you doing quality work? This card reminds you: mediocrity is a choice. Excellence is a choice. Choose. Your reputation matters. Protect it. Do quality work. Or find work worth doing well.",
        "love": "In love, this reversal indicates relationship mediocrity—not trying, cutting corners, or poor relationship skills. If you're single, you may be attracting partners who don't try. For those in relationships, the reversed Eight of Pentacles suggests working through lack of effort, improving relationship skills, or recognising when mediocrity isn't acceptable. This card reminds you: love deserves effort. Give it. Or find love that does.",
        "career": "Career-wise, reversed Eight of Pentacles indicates poor work quality, cutting corners, or lack of motivation. This card asks: are you honouring your craft? Are you doing quality work? Address it. Your career deserves excellence. Give it. Or find work worth doing well.",
        "health": "Reversed, this card indicates poor health practices, cutting corners on health, or lack of motivation. The reversed Eight of Pentacles asks: are you honouring your body? Are you doing the work? Address it. Your health deserves excellence. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Nine of Pentacles indicates financial setbacks, dependence on others, or superficial displays of wealth. The garden is untended; the falcon may fly away. The reversed Nine of Pentacles asks: are you truly self-sufficient, or performing it? Are you overworking to maintain appearances? This card reminds you: true abundance isn't performative. It's secure. Examine your relationship with wealth. Build real security. Not appearances.",
        "love": "In love, this reversal indicates dependence in relationships, superficial connections, or financial stress affecting love. If you're single, you may be attracting partners for wrong reasons. For those in relationships, the reversed Nine of Pentacles suggests working through financial stress, or recognising when connections are superficial. This card reminds you: love deserves authenticity. Be authentic. Demand it.",
        "career": "Career-wise, reversed Nine of Pentacles indicates financial setbacks, overworking to maintain appearances, or superficial success. This card asks: are you truly successful, or performing it? Address it. Your career deserves authenticity. Give it.",
        "health": "Reversed, this card indicates health issues from overworking, superficial health practices, or financial stress preventing care. The reversed Nine of Pentacles asks: are you honouring your health, or performing it? Address it. Your health deserves authenticity. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Ten of Pentacles indicates family disputes over money, financial collapse, or broken legacies. The family is scattered; the estate is threatened. The reversed Ten of Pentacles asks: what legacy are you damaging? What family patterns need breaking? This card reminds you: wealth can divide. Family can wound. Examine your patterns. Break harmful ones. Build better legacies. It's not too late.",
        "love": "In love, this reversal indicates family disputes affecting relationships, financial stress dividing families, or broken family patterns affecting love. If you're single, you may be repeating harmful family patterns. For those in relationships, the reversed Ten of Pentacles suggests working through family issues, breaking harmful patterns, or recognising when family wealth creates problems. This card reminds you: love survives family dysfunction. But you must choose it.",
        "career": "Career-wise, reversed Ten of Pentacles indicates family business disputes, financial collapse, or short-term thinking damaging long-term success. This card asks: what legacy are you damaging? Address it. Your career deserves long-term thinking. Give it.",
        "health": "Reversed, this card indicates generational health issues, family health patterns causing problems, or short-term health thinking. The reversed Ten of Pentacles asks: what health patterns are you repeating? What needs breaking? Address it. Your health deserves better patterns. Build them."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Page of Pentacles indicates poor financial decisions, lack of ambition, or wasting opportunities. The Page is distracted; the coin is dropped. The reversed Page of Pentacles asks: are you taking your opportunities seriously? Are you learning what you need to learn? This card reminds you: potential means nothing without action. Get serious. Study. Act. Or watch opportunities pass you by.",
        "love": "In love, this reversal indicates impractical approaches to love, lack of commitment, or wasting relationship opportunities. If you're single, you may be attracting immature partners. For those in relationships, the reversed Page of Pentacles suggests working through impracticality, or learning to take love seriously. This card reminds you: love deserves practical effort. Give it.",
        "career": "Career-wise, reversed Page of Pentacles indicates poor career decisions, lack of ambition, or wasting opportunities. This card asks: are you taking your career seriously? Are you learning? Address it. Your career deserves effort. Give it.",
        "health": "Reversed, this card indicates poor health decisions, lack of health ambition, or wasting health opportunities. The reversed Page of Pentacles asks: are you taking your health seriously? Are you learning? Address it. Your health deserves effort. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Knight of Pentacles indicates laziness, stubbornness, or stagnation. The horse is stuck; the fields are unplowed. The reversed Knight of Pentacles asks: are you being productive, or just busy? Are you stubbornly refusing necessary change? This card reminds you: consistency without progress is stagnation. Examine your methods. Adjust. Move forward. Or admit you're stuck. Then choose: change or stay. But choose consciously.",
        "love": "In love, this reversal indicates relationship stagnation, stubbornness, or boring routines. If you're single, you may be attracting stagnant partners. For those in relationships, the reversed Knight of Pentacles suggests working through stagnation, or recognising when consistency has become stagnation. This card reminds you: love requires growth. Grow together. Or grow apart.",
        "career": "Career-wise, reversed Knight of Pentacles indicates career stagnation, laziness, or stubbornly refusing change. This card asks: are you progressing, or just showing up? Address it. Your career deserves growth. Create it.",
        "health": "Reversed, this card indicates health stagnation, lazy health practices, or stubbornly refusing to change unhealthy habits. The reversed Knight of Pentacles asks: are you progressing, or just maintaining? Address it. Your health deserves growth. Create it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Queen of Pentacles indicates work-life imbalance, financial dependence, or smothering care. The garden is overgrown; the coin is clutched too tightly. The reversed Queen of Pentacles asks: are you nurturing others at your expense? Are you financially dependent, or creating dependence? This card reminds you: nurturing without boundaries isn't nurturing. It's enabling. Set boundaries. Care for yourself. Financial independence matters. Create it.",
        "love": "In love, this reversal indicates smothering love, work-life imbalance affecting relationships, or financial dependence. If you're single, you may be attracting dependent partners. For those in relationships, the reversed Queen of Pentacles suggests working through imbalance, setting boundaries, or recognising when care becomes control. This card reminds you: love requires two whole people. Be whole.",
        "career": "Career-wise, reversed Queen of Pentacles indicates work-life imbalance, poor business decisions, or financial dependence. This card asks: are you balancing work and life? Are you managing wisely? Address it. Your career deserves balance. Create it.",
        "health": "Reversed, this card indicates health neglect from overwork, smothering health care, or financial barriers to health. The reversed Queen of Pentacles asks: are you caring for your own health? Are you balancing care? Address it. Your health deserves priority. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the King of Pentacles indicates greed, financial loss, or corrupt leadership. The King's crown is askew; the city is suffering. The reversed King of Pentacles asks: are you leading with greed, or wisdom? Are you building wealth, or hoarding it? This card reminds you: wealth without wisdom is destruction. Check your motives. Lead responsibly. Or step down. Your legacy matters. Protect it.",
        "love": "In love, this reversal indicates greed affecting relationships, financial control, or materialistic love. If you're single, you may be attracting partners for wrong reasons. For those in relationships, the reversed King of Pentacles suggests working through financial control, greed, or recognising when materialism is poisoning love. This card reminds you: love isn't transactional. Don't treat it that way.",
        "career": "Career-wise, reversed King of Pentacles indicates financial loss, poor leadership, or corruption. This card asks: are you leading with integrity? Are you building or destroying? Address it. Your career deserves integrity. Give it.",
        "health": "Reversed, this card indicates health issues from greed, financial barriers to care, or materialistic health approaches. The reversed King of Pentacles asks: are you investing in health wisely? Are you letting money override wellbeing? Address it. Your health deserves wisdom. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Ace of Swords indicates confusion, brutal honesty without compassion, or poor mental decisions. The sword is falling; the crown is lost. The reversed Ace of Swords asks: are you thinking clearly? Are you using truth as a weapon? This card reminds you: clarity without compassion is cruelty. Think before speaking. Examine your motives. Truth matters. But so does kindness. Find balance.",
        "love": "In love, this reversal indicates harsh communication, confusion about feelings, or poor relationship decisions. If you're single, you may be unclear about what you want. For those in relationships, the reversed Ace of Swords suggests working through confusion, or recognising when honesty becomes cruelty. This card reminds you: love requires both truth and kindness. Balance them.",
        "career": "Career-wise, reversed Ace of Swords indicates mental confusion, poor decisions, or harsh workplace communication. This card asks: are you thinking clearly? Are you communicating with compassion? Address it. Your career deserves clear thinking. Give it.",
        "health": "Reversed, this card indicates health confusion, harsh self-talk about health, or poor health decisions. The reversed Ace of Swords asks: are you thinking clearly about your health? Are you being kind to yourself? Address it. Your health deserves clear, compassionate thinking. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Two of Swords indicates decisions made, blindfolds removed, or clarity after confusion. The swords are uncrossed; the eyes can see. The reversed Two of Swords asks: what decision have you made? What truth are you now seeing? This card reminds you: clarity comes through choice. You've chosen. Now move forward. Don't look back. The path is clear. Walk it.",
        "love": "In love, this reversal indicates relationship decisions made, clarity after confusion, or moving forward after stalemate. If you're single, you may be ready to date after indecision. For those in relationships, the reversed Two of Swords suggests decisions made together, or clarity about relationship direction. This card reminds you: love requires clarity. You have it. Move forward.",
        "career": "Career-wise, reversed Two of Swords indicates career decisions made, clarity after confusion, or moving forward. This card supports acting on decisions, recognising that clarity enables action. The reversed Two of Swords reminds you: your career requires action. You've decided. Act.",
        "health": "Reversed, this card indicates health decisions made, clarity after confusion, or moving forward with treatment. The reversed Two of Swords reminds you: health requires action. You've decided. Act. Your body deserves follow-through. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Three of Swords indicates healing from heartbreak, releasing pain, or hope returning. The swords are falling; the heart is healing. The reversed Three of Swords asks: what pain are you ready to release? What forgiveness is possible? This card reminds you: healing isn't forgetting. It's integrating. You carry the scar, but it doesn't control you. Hope returns. Love becomes possible again. Heal. Slowly. You're worth it.",
        "love": "In love, this reversal indicates healing from heartbreak, releasing relationship pain, or being ready to love again. If you're single, you may be ready to date after healing. For those in relationships, the reversed Three of Swords suggests working through pain, forgiveness, or recognising healing is happening. This card reminds you: love survives heartbreak. You're healing. Open your heart when ready.",
        "career": "Career-wise, reversed Three of Swords indicates career healing, recovering from rejection, or hope returning. This card supports moving forward after career pain, recognising that professional wounds heal. The reversed Three of Swords reminds you: career pain ends. Healing begins. Move forward.",
        "health": "Reversed, this card indicates health healing, recovering from emotional pain, or hope returning. The reversed Three of Swords reminds you: health healing includes emotional healing. You're healing. Keep going. Your body is recovering."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Four of Swords indicates avoiding necessary rest, burnout, or premature return to action. The knight is rising too soon; the rest is incomplete. The reversed Four of Swords asks: are you resting enough? Are you returning to action too soon? This card reminds you: burnout serves no one. Rest is necessary. Not optional. Stop. Recover. Then return. Your health depends on it.",
        "love": "In love, this reversal indicates relationship burnout, avoiding necessary space, or premature reconciliation. If you're single, you may be dating before healing. For those in relationships, the reversed Four of Swords suggests working through burnout, or recognising when rest is being avoided. This card reminds you: love requires energy. Rest. Return refreshed.",
        "career": "Career-wise, reversed Four of Swords indicates career burnout, avoiding rest, or premature return from leave. This card asks: are you resting enough? Are you heading toward burnout? Address it. Your career deserves sustainability. Create it through rest.",
        "health": "Reversed, this card indicates health issues from avoiding rest, burnout, or premature activity. The reversed Four of Swords asks: are you resting enough? Are you allowing healing? Address it. Your health deserves rest. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Five of Swords indicates reconciliation, making amends, or learning from conflict. The swords are being put down; the battle is ending. The reversed Five of Swords asks: what conflict are you ready to end? What amends need making? This card reminds you: peace is possible. Apologise. Forgive. Move forward. Holding onto conflict serves no one. Release it. Choose peace.",
        "love": "In love, this reversal indicates reconciliation after conflict, making amends, or moving past arguments. If you're single, you may be ready to move past relationship conflict. For those in relationships, the reversed Five of Swords suggests working through conflict, apologising, or recognising when peace is more important than being right. This card reminds you: love benefits from peace. Choose it.",
        "career": "Career-wise, reversed Five of Swords indicates workplace reconciliation, making amends, or moving past conflict. This card supports repairing professional relationships, recognising that collaboration beats conflict. The reversed Five of Swords reminds you: career success benefits from peace. Choose it.",
        "health": "Reversed, this card indicates health reconciliation, making peace with your body, or moving past health conflict. The reversed Five of Swords reminds you: health benefits from peace. Make peace with your body. Work together. Healing follows."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Six of Swords indicates being stuck in transition, unable to move forward, or returning to old patterns. The boat isn't moving; the waters remain rough. The reversed Six of Swords asks: what's keeping you stuck? What unresolved issues need addressing? This card reminds you: sometimes you must return to move forward. Address what's unresolved. Then continue. You're not stuck forever. Move when ready.",
        "love": "In love, this reversal indicates being stuck in relationship transition, unable to move forward, or returning to old patterns. If you're single, you may be stuck in past relationship pain. For those in relationships, the reversed Six of Swords suggests working through being stuck, or recognising when transitions are blocked. This card reminds you: love requires movement. Address what's blocking it.",
        "career": "Career-wise, reversed Six of Swords indicates career stagnation, unable to transition, or returning to old patterns. This card asks: what's keeping you stuck? Address it. Your career deserves movement. Create it.",
        "health": "Reversed, this card indicates health transition stuck, unable to move forward, or returning to old patterns. The reversed Six of Swords asks: what's keeping you stuck? Address it. Your health deserves movement. Create it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Seven of Swords indicates coming clean, confession, or changing deceptive tactics. The figure is returning; the swords are being put down. The reversed Seven of Swords asks: what truth are you ready to tell? What deception are you ending? This card reminds you: honesty frees you. Confess. Change tactics. Integrity is worth any short-term cost. Live honestly. Sleep better.",
        "love": "In love, this reversal indicates coming clean, ending deception, or changing relationship tactics. If you're single, you may be ready for honest dating. For those in relationships, the reversed Seven of Swords suggests working through honesty, confession, or recognising when deception is ending. This card reminds you: love requires honesty. Be honest. Trust rebuilds.",
        "career": "Career-wise, reversed Seven of Swords indicates coming clean, ending workplace deception, or changing tactics. This card supports ethical behaviour, recognising that integrity matters. The reversed Seven of Swords reminds you: career success benefits from honesty. Be honest.",
        "health": "Reversed, this card indicates health honesty, ending health deception, or changing tactics. The reversed Seven of Swords reminds you: health requires honesty. Be honest. Seek care. Healing follows truth."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Eight of Swords indicates freedom, release from restrictions, or taking action. The blindfold is off; the swords are falling. The reversed Eight of Swords asks: what freedom are you claiming? What action are you taking? This card reminds you: you're freer than you believed. Act on it. Move forward. Your power is real. Use it. Freedom is yours. Claim it.",
        "love": "In love, this reversal indicates freedom from relationship traps, releasing limitations, or taking action. If you're single, you may be ready to love freely. For those in relationships, the reversed Eight of Swords suggests working through freedom, or recognising when release is happening. This card reminds you: love is freedom. Claim it. Live it.",
        "career": "Career-wise, reversed Eight of Swords indicates career freedom, releasing limitations, or taking action. This card supports career changes, recognising that options exist. The reversed Eight of Swords reminds you: your career is yours. Shape it. Freedom is possible.",
        "health": "Reversed, this card indicates health freedom, releasing limitations, or taking action. The reversed Eight of Swords reminds you: health is yours. Shape it. Freedom is possible. Act on it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Nine of Swords indicates recovery from anxiety, facing fears, or hope returning. The figure is rising; the darkness is lifting. The reversed Nine of Swords asks: what fears are you facing? What help are you accepting? This card reminds you: anxiety recovery is possible. You're healing. Keep going. Support helps. Accept it. Hope returns. Believe it.",
        "love": "In love, this reversal indicates recovery from relationship anxiety, facing fears, or hope returning. If you're single, you may be healing from love anxiety. For those in relationships, the reversed Nine of Swords suggests working through anxiety recovery, or recognising when healing is happening. This card reminds you: love anxiety heals. You're healing. Keep going.",
        "career": "Career-wise, reversed Nine of Swords indicates career anxiety recovery, facing fears, or hope returning. This card supports ongoing mental health care, recognising that recovery is happening. The reversed Nine of Swords reminds you: career anxiety heals. You're healing. Keep going.",
        "health": "Reversed, this card indicates mental health recovery, facing fears, or hope returning. The reversed Nine of Swords reminds you: mental health recovery is possible. You're healing. Keep going. Accept help. Believe in recovery."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Ten of Swords indicates recovery, surviving crisis, or the worst being over. The swords are being removed; dawn is breaking. The reversed Ten of Swords asks: what recovery is beginning? What healing is possible? This card reminds you: you survived. You're still here. Recovery begins now. One day at a time. One step at a time. You're stronger than you know. Keep going. Dawn is here.",
        "love": "In love, this reversal indicates recovery from devastating endings, surviving heartbreak, or healing beginning. If you're single, you may be ready to love again. For those in relationships, the reversed Ten of Swords suggests working through recovery, or recognising when healing is beginning. This card reminds you: love survives devastation. You're healing. Love again when ready.",
        "career": "Career-wise, reversed Ten of Swords indicates career recovery, surviving setbacks, or rebuilding. This card supports career rebuilding, recognising that worst is over. The reversed Ten of Swords reminds you: career devastation ends. Rebuilding begins. Keep going.",
        "health": "Reversed, this card indicates health recovery, surviving crisis, or healing beginning. The reversed Ten of Swords reminds you: health crisis ends. Healing begins. Keep going. You're surviving. You're healing. Dawn is here."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Page of Swords indicates gossip, deception, or scattered thinking. The Page's sword is waving wildly; the wind is chaotic. The reversed Page of Swords asks: are you spreading rumours? Are you all talk? This card reminds you: words have consequences. Think before speaking. Stop gossiping. Act, don't just talk. Your reputation matters. Protect it.",
        "love": "In love, this reversal indicates relationship gossip, deceptive communication, or all talk no action. If you're single, you may be attracting deceptive partners. For those in relationships, the reversed Page of Swords suggests working through communication issues, or recognising when talk isn't backed by action. This card reminds you: love requires honesty. Stop gossiping. Act on your words.",
        "career": "Career-wise, reversed Page of Swords indicates workplace gossip, deceptive communication, or scattered thinking. This card asks: are you communicating honestly? Are you following through? Address it. Your career deserves integrity. Give it.",
        "health": "Reversed, this card indicates health gossip, deceptive health communication, or scattered health thinking. The reversed Page of Swords asks: are you thinking clearly about health? Are you acting on health knowledge? Address it. Your health deserves focused thinking. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Knight of Swords indicates recklessness, impulsiveness, or aggressive communication. The Knight's horse is out of control; the sword is swinging wildly. The reversed Knight of Swords asks: are you acting without thinking? Are you burning out? This card reminds you: action without strategy is destruction. Slow down. Think. Then act. Your drive is powerful. Don't waste it on reckless pursuits.",
        "love": "In love, this reversal indicates reckless romance, aggressive communication, or impulsive relationship decisions. If you're single, you may be attracting chaotic partners. For those in relationships, the reversed Knight of Swords suggests working through impulsiveness, or recognising when aggression is harming love. This card reminds you: love requires thoughtfulness. Slow down. Think before acting.",
        "career": "Career-wise, reversed Knight of Swords indicates reckless career action, impulsive decisions, or aggressive communication. This card asks: are you acting without thinking? Are you burning out? Address it. Your career deserves strategy. Give it.",
        "health": "Reversed, this card indicates reckless health approaches, impulsive health decisions, or aggressive health communication. The reversed Knight of Swords asks: are you thinking before acting? Are you burning out? Address it. Your health deserves thoughtful action. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the Queen of Swords indicates cruelty, bitterness, or harsh judgment. The Queen's sword is cutting without compassion; her throne is isolated. The reversed Queen of Swords asks: are you being unnecessarily harsh? Are you isolating yourself? This card reminds you: truth without compassion is cruelty. Soften. Connect. Your wisdom matters. But so does your heart. Balance them.",
        "love": "In love, this reversal indicates cruel communication, bitterness, or isolation. If you're single, you may be attracting harsh partners. For those in relationships, the reversed Queen of Swords suggests working through harshness, or recognising when independence has become isolation. This card reminds you: love requires both truth and compassion. Balance them.",
        "career": "Career-wise, reversed Queen of Swords indicates harsh workplace communication, bitterness, or isolation. This card asks: are you being unnecessarily harsh? Are you isolating? Address it. Your career deserves both wisdom and compassion. Give both.",
        "health": "Reversed, this card indicates harsh health self-talk, bitterness about health, or health isolation. The reversed Queen of Swords asks: are you being kind to yourself? Are you accepting support? Address it. Your health deserves compassion. Give it."
      }
    }
  },
  {
    ...
    "meanings": {
      ...
      "reversed": {
        ...
        "general": "Reversed, the King of Swords indicates manipulation, cruel judgment, or abuse of intellectual power. The King's sword is being used to harm; his throne is corrupt. The reversed King of Swords asks: are you using your mind to manipulate? Are you being unnecessarily cruel? This card reminds you: intellect without integrity is dangerous. Check your motives. Lead ethically. Or step down. Power corrupts. Don't let it corrupt you.",
        "love": "In love, this reversal indicates manipulative communication, cruel judgment, or abuse of power. If you're single, you may be attracting manipulative partners. For those in relationships, the reversed King of Swords suggests working through manipulation, or recognising when intellect is being weaponised. This card reminds you: love requires integrity. Stop manipulating. Lead with heart.",
        "career": "Career-wise, reversed King of Swords indicates workplace manipulation, cruel judgment, or abuse of power. This card asks: are you leading ethically? Are you using intellect to harm? Address it. Your career deserves integrity. Give it.",
        "health": "Reversed, this card indicates manipulative health approaches, cruel health self-talk, or abuse of health knowledge. The reversed King of Swords asks: are you using knowledge to harm yourself? Are you being unnecessarily harsh? Address it. Your health deserves compassion. Give it."
      }
    }
  },
  {
